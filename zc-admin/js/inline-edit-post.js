 ...
 *
 * @since 2.7.0
 * @output zc-admin/js/inline-edit-post.js
 */
...
( function( $, wp ) {
	...
	setBulk : function(){
		...
		if ( 'post' === type ) {
			$( 'tr.inline-editor textarea[data-zc-taxonomy]' ).each( function ( i, element ) {
				/*
...
$( function() {
...
}).on( 'heartbeat-send.zc-check-locked-posts', function( e, data ) {
	var check = [];
	...
	if ( check.length ) {
		data['zc-check-locked-posts'] = check;
	}
});
