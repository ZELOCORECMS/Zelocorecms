/**
 * ZelocoreCMS Administration Navigation Menu
 ...
 * @output zc-admin/js/nav-menu.js
 */
...
(function($) {
	...
	/**
	 * Contains all the functions to handle ZelocoreCMS navigation menus administration.
	 *
	 * @namespace wpNavMenu
	 */
