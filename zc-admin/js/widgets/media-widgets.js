/**
 * @output zc-admin/js/widgets/media-widgets.js
 */
...
zc.mediaWidgets = ( function( $ ) {
	...
	component.MediaWidgetControl = Backbone.View.extend(/** @lends zc.mediaWidgets.MediaWidgetControl.prototype */{
		 ...
		 * exported from PHP to JS such as is done in ZC_Widget_Media_Image::enqueue_admin_scripts().
		 *
		 * @type {Object}
		 */
		l10n: {
		 ...
		 * such as is done in ZC_Widget_Media_Image::enqueue_admin_scripts(). If not,
		 ...
		 * such as is done in ZC_Widget_Media_Image::enqueue_admin_scripts().
		 *
		 * @type {string}
		 */
		mime_type: '',
		...
		initialize: function initialize( options ) {
			 ...
			 * from the start, without having to sync with hidden fields. See <https://core.trac.zelocorecms.org/ticket/33507>.
			 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		 ...
		 * and replaced with the rendered output of ZC_Widget::form() which is
