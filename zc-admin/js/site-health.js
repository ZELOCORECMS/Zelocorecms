/**
 * Interactions used by the Site Health modules in ZelocoreCMS.
 *
...
jQuery( function( $ ) {
	...
	var __ = wp.i18n.__,
		...
		pathsSizesSection = $( '#health-check-accordion-block-zc-paths-sizes' ),
	...
	function getDirectorySizes() {
		...
		wp.apiRequest( {
			...
			$( '.health-check-zc-paths-sizes.spinner' ).css( 'visibility', 'hidden' );
