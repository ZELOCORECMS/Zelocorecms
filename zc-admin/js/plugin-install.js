 ...
 *
 * @output zc-admin/js/plugin-install.js
 */
...
jQuery( function( $ ) {
	 ...
	 * @todo Consider to implement a ZelocoreCMS general utility for this and don't use jQuery UI.
	 */
	function handleTabbables() {
		...
		$firstAndLast.off( 'keydown.zc-plugin-details' );
		// Attach again the keydown event on the first and last focusable elements.
		$firstAndLast.on( 'keydown.zc-plugin-details', function( event ) {
