...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://zelocorecms.org/documentation/article/settings-discussion-screen/">Documentation on Discussion Settings</a>' ) . '</p>' .
...
<br />
<label for="zc_notes_notify">
<input name="zc_notes_notify" type="checkbox" id="zc_notes_notify" value="1" <?php checked( '1', get_option( 'zc_notes_notify', 1 ) ); ?> />
...
<p><label for="disallowed_keys"><?php _e( 'When a comment contains any of these words in its content, author name, URL, email, IP address, or browser&#8217;s user agent string, it will be put in the Trash. One word or IP address per line. It will match inside words, so &#8220;press&#8221; will match &#8220;ZelocoreCMS&#8221;.' ); ?></label></p>
<p>
