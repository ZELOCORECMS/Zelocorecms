...
/**
 * ZelocoreCMS Filesystem Class for direct PHP file and folder manipulation.
 *
 * @since 2.5.0
 *
 * @see ZC_Filesystem_Base
 */
class ZC_Filesystem_Direct extends ZC_Filesystem_Base {
