<?php
/**
 * Upgrader API: ZC_Ajax_Upgrader_Skin class
 *
 * @package ZelocoreCMS
 * @subpackage Upgrader
 * @since 4.6.0
...
/**
 * Upgrader Skin for Ajax ZelocoreCMS upgrades.
 *
 ...
 */
class ZC_Ajax_Upgrader_Skin extends Automatic_Upgrader_Skin {
	 ...
	 * which in turn calls the zc_get_theme() function.
	 *
	 * @var ZC_Theme|false The theme's info object, or false.
	 */
	public $theme_info = false;

	/**
	 * Holds the ZC_Error object.
	 *
	 * @since 4.6.0
	 *
	 * @var null|ZC_Error
	 ...
	 * Constructor.
	 *
	 * Sets up the ZelocoreCMS Ajax upgrader skin.
	 *
	 * @since 4.6.0
	 *
	 * @see ZC_Upgrader_Skin::__construct()
	 *
	 * @param array $args Optional. The ZelocoreCMS Ajax upgrader skin arguments to
	 *                    override default options. See ZC_Upgrader_Skin::__construct().
	 *                    Default empty array.
	 */
	 ...
	 * @since 4.6.0
	 *
	 * @return ZC_Error Errors during an upgrade.
	 */
	 ...
	 *
	 * @param string|array|ZC_Error $feedback Message data.
	 * @param mixed                 ...$args  Optional text replacements.
	 */
	public function feedback( $feedback, ...$args ) {
		if ( is_zc_error( $feedback ) ) {
