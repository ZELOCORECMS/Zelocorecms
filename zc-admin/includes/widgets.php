<?php
/**
 * ZelocoreCMS Widgets Administration API
 *
 * @package ZelocoreCMS
...
function zc_list_widgets() {
	...
	foreach ( $sort as $widget ) {
		...
		if ( isset( $zc_registered_widget_controls[ $widget['id'] ]['id_base'] ) && isset( $widget['params'][0]['number'] ) ) {
		...
		$sidebar_args = zc_list_widget_controls_dynamic_sidebar( $control_args );

		zc_widget_control( ...$sidebar_args );
	}
}
 ...
 */
function zc_list_widget_controls( $sidebar, $sidebar_name = '' ) {
	add_filter( 'dynamic_sidebar_params', 'zc_list_widget_controls_dynamic_sidebar' );

	$description = zc_sidebar_description( $sidebar );
 ...
 */
function zc_list_widget_controls_dynamic_sidebar( $params ) {
	...
	if ( is_callable( $zc_registered_widgets[ $widget_id ]['callback'] ) ) {
		$zc_registered_widgets[ $widget_id ]['_callback'] = $zc_registered_widgets[ $widget_id ]['callback'];
		$zc_registered_widgets[ $widget_id ]['callback']  = 'zc_widget_control';
	}
 ...
 */
function zc_widget_control( $sidebar_args ) {
	global $zc_registered_widgets, $zc_registered_widget_controls, $sidebars_widgets;
	...
	$control    = $zc_registered_widget_controls[ $widget_id ] ?? array();
	...
	$zc_registered_widgets[ $widget_id ]['callback'] = $zc_registered_widgets[ $widget_id ]['_callback'];
	unset( $zc_registered_widgets[ $widget_id ]['_callback'] );
	...
	<?php
	$widget_description = zc_widget_description( $widget_id );
 ...
 */
function zc_widgets_access_body_class( $classes ) {
