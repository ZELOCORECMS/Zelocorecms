<?php
/**
 * List Table API: ZC_Privacy_Data_Removal_Requests_List_Table class
 *
 * @package ZelocoreCMS
...
if ( ! class_exists( 'ZC_Privacy_Requests_Table' ) ) {
	require_once ABSPATH . 'zc-admin/includes/class-zc-privacy-requests-table.php';
}

/**
 * ZC_Privacy_Data_Removal_Requests_List_Table class.
 *
 * @since 4.9.6
 */
class ZC_Privacy_Data_Removal_Requests_List_Table extends ZC_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		if ( 'request-confirmed' !== $status ) {
			...
			$nonce         = zc_create_nonce( 'zc-privacy-erase-personal-data-' . $request_id );
