<?php
/**
 * ZelocoreCMS Filesystem Class for implementing SSH2
 *
 ...
 *
 * Note: As of ZelocoreCMS 2.8, this utilizes the PHP5+ function `stream_get_contents()`.
 *
 * @since 2.7.0
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Filesystem_SSH2 extends ZC_Filesystem_Base {
