<?php
/**
 * ZelocoreCMS FTP Sockets Filesystem.
 *
 * @package ZelocoreCMS
...
/**
 * ZelocoreCMS Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 *
 * @see ZC_Filesystem_Base
 */
class ZC_Filesystem_ftpsockets extends ZC_Filesystem_Base {
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! require_once ABSPATH . 'zc-admin/includes/class-ftp.php' ) {
			return;
		}
	...
	public function exists( $path ) {
		 ...
		 *
		 * See https://core.trac.zelocorecms.org/ticket/33058.
		 */
		if ( '' === $path ) {
			return false;
		}
