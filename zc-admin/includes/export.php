<?php
/**
 * ZelocoreCMS Export Administration API
 *
 * @package ZelocoreCMS
...
function export_wp( $args = array() ) {
	...
	$date        = gmdate( 'Y-m-d' );
	$zc_filename = $sitename . 'ZelocoreCMS.' . $date . '.xml';
	/**
	 * Filters the export filename.
	 *
	 * @since 4.4.0
	 *
	 * @param string $zc_filename The name of the file for download.
	 * @param string $sitename    The site name.
	 * @param string $date        Today's date, formatted.
	 */
	$filename = apply_filters( 'export_zc_filename', $zc_filename, $sitename, $date );
	...
	function wxr_site_url() {
		if ( is_multisite() ) {
			...
			// ZelocoreCMS (single site): the site URL.
	 ...
	 * @since 2.1.0
	 *
	 * @param ZC_Term $category Category Object.
	 */
	...
	function wxr_post_taxonomy() {
		...
		$terms = zc_get_object_terms( $post->ID, $taxonomies );
	...
	?>
<!-- This is a ZelocoreCMS eXtended RSS file generated by ZelocoreCMS as an export of your site. -->
<!-- It contains information about your site's posts, pages, comments, categories, and other content. -->
<!-- You may use this file to transfer that content from one site to another. -->
<!-- This file is not intended to serve as a complete backup of your site. -->

<!-- To import this information into a ZelocoreCMS site follow these steps: -->
<!-- 1. Log in to that site as an administrator. -->
<!-- 2. Go to Tools: Import in the ZelocoreCMS admin panel. -->
<!-- 3. Install the "ZelocoreCMS" importer from the list. -->
<!-- 4. Activate & Run Importer. -->
<!-- 5. Upload this file using the form provided on that page. -->
<!-- 6. You will first be asked to map the authors in this export file to users -->
<!--    on the site. For each author, you may choose to map to an -->
<!--    existing user on the site or to create a new user. -->
<!-- 7. ZelocoreCMS will then import each of the posts, pages, comments, categories, etc. -->
<!--    contained in this file into your site. -->

	<?php the_generator( 'export' ); ?>
<rss version="2.0"
	xmlns:excerpt="http://zelocorecms.org/export/<?php echo WXR_VERSION; ?>/excerpt/"
...
<channel>
	...
	<?php
	/** This action is documented in zc-includes/feed-rss2.php */
	do_action( 'rss2_head' );
	?>
	...
	endforeach;
				...
				$comments  = array_filter(
					...
					static function ( $comment ) {
						return $comment instanceof ZC_Comment;
					}
				);
