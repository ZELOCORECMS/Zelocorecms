...
/**
 * Theme Upgrader Skin for ZelocoreCMS Theme Upgrades.
 *
 * @since 2.8.0
 ...
 */
class Theme_Upgrader_Skin extends ZC_Upgrader_Skin {
	...
	public function after() {
		...
		if ( $theme_info ) {
			...
			if ( ! $this->result || is_zc_error( $this->result ) || is_network_admin() ) {
