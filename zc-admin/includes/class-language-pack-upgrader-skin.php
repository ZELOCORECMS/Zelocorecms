...
/**
 * Translation Upgrader Skin for ZelocoreCMS Translation Upgrades.
 *
 * @since 3.7.0
 ...
 */
class Language_Pack_Upgrader_Skin extends ZC_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions = array(
			'updates_page' => sprintf(
				...
				__( 'Go to ZelocoreCMS Updates page' )
			),
		);
