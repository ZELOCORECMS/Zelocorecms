<?php
/**
 * List Table API: ZC_Privacy_Data_Export_Requests_List_Table class
 *
 * @package ZelocoreCMS
...
/**
 * ZC_Privacy_Data_Export_Requests_Table class.
 *
 * @since 4.9.6
 */
class ZC_Privacy_Data_Export_Requests_List_Table extends ZC_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		$status          = $item->status;
		$request_id      = $item->ID;
		$nonce           = zc_create_nonce( 'zc-privacy-export-personal-data-' . $request_id );
