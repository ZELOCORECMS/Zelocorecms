<?php
/**
 * List Table API: ZC_Application_Passwords_List_Table class
 *
 * @package ZelocoreCMS
 ...
 * @see ZC_List_Table
 */
class ZC_Application_Passwords_List_Table extends ZC_List_Table {
	...
	public function prepare_items() {
		global $user_id;
		$this->items = array_reverse( ZC_Application_Passwords::get_user_application_passwords( $user_id ) );
	}
	...
	public function print_js_template_row() {
		...
		foreach ( $columns as $column_name => $display_name ) {
			...
			printf( '<td class="%s" data-colname="%s">', esc_attr( $classes ), esc_attr( zc_strip_all_tags( $display_name ) ) );
