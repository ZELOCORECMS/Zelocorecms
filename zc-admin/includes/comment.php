 ...
 *
 * @return int|ZC_Error The value 1 if the comment was updated, 0 if not updated.
 *                      A ZC_Error object on failure.
 */
function edit_comment() {
	if ( ! current_user_can( 'edit_comment', (int) $_POST['comment_ID'] ) ) {
		zc_die( __( 'Sorry, you are not allowed to edit comments on this post.' ) );
	}
	...
	return zc_update_comment( $_POST, true );
}

/**
 * Returns a ZC_Comment object based on comment ID.
 *
 * @since 2.0.0
 *
 * @param int $id ID of comment to retrieve.
 * @return ZC_Comment|false Comment if found. False on failure.
 */
...
function enqueue_comment_hotkeys_js() {
	if ( 'true' === get_user_option( 'comment_shortcuts' ) ) {
		zc_enqueue_script( 'jquery-table-hotkeys' );
	}
}
