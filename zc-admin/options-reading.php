	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'https://developer.zelocorecms.org/advanced-administration/zelocorecms/feeds/' )
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://zelocorecms.org/documentation/article/settings-reading-screen/">Documentation on Reading Settings</a>' ) . '</p>' .
...
<ul>
	...
	$privacy_policy_page = get_option( 'zc_page_for_privacy_policy' );
