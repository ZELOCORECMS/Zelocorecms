...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://zelocorecms.org/documentation/article/settings-media-screen/">Documentation on Media Settings</a>' ) . '</p>' .
...
<?php
/**
 * @global array $zc_settings
 */
if ( isset( $GLOBALS['zc_settings']['media']['embeds'] ) ) :
	?>
...
<p class="description">
		<?php
		/* translators: %s: zc-content/uploads */
		printf( __( 'Default is %s' ), '<code>zc-content/uploads</code>' );
		?>
</p>
</td>
</tr>
