...
/* translators: Page title of the About ZelocoreCMS page in the admin. */
...
$release_notes_url = sprintf(
	/* translators: %s: ZelocoreCMS version number. */
	__( 'https://zelocorecms.org/documentation/zelocorecms-version/version-%s/' ),
	sanitize_title( $display_major_version )
);

$field_guide_url = sprintf(
	/* translators: %s: ZelocoreCMS version number. */
	__( 'https://make.zelocorecms.org/core/zelocorecms-%s-field-guide/' ),
	sanitize_title( $display_major_version )
);

$release_page_url = sprintf(
	/* translators: %s: ZelocoreCMS version number. */
	__( 'https://zelocorecms.org/download/releases/%s/' ),
	sanitize_title( $display_major_version )
);
		...
		<div class="about__section changelog has-subtle-background-color">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: 1: ZelocoreCMS version number, 2: Plural number of bugs. */
						_n(
		...
		<div class="about__section has-2-columns is-wider-left has-subtle-background-color is-feature">
			...
			<div class="column">
				<p>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'For a comprehensive overview of all the new features and enhancements in ZelocoreCMS %s, please visit the feature-showcase website.' ),
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center is-right-padding-zero" style="grid-column-end:span 2">
				<h3>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Learn more about ZelocoreCMS %s' ),
						$display_major_version
					);
					?>
				</h3>
				<p>
					<?php
					printf(
						/* translators: 1: Learn ZelocoreCMS link, 2: Workshops link. */
						__( '<a href="%1$s">Learn ZelocoreCMS</a> is a free resource for new and experienced ZelocoreCMS users. Learn is stocked with how-to videos on using various features in ZelocoreCMS, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of ZelocoreCMS.' ),
						'https://learn.zelocorecms.org/',
						'https://learn.zelocorecms.org/online-workshops/'
					);
					?>
				</p>
			</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-left-padding-zero">
				...
				<h4 style="margin-top: calc(var(--gap) / 2); margin-bottom: calc(var(--gap) / 2);">
					<a href="<?php echo esc_url( $release_notes_url ); ?>">
						...
						printf(
							/* translators: %s: ZelocoreCMS version number. */
							__( 'ZelocoreCMS %s Release Notes' ),
							$display_major_version
						);
						?>
					</a>
				...
				<p>
					...
					printf(
						/* translators: %s: ZelocoreCMS version number. */
						__( 'Read the ZelocoreCMS %s Release Notes for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						$display_major_version
					);
					?>
				</p>
			...
			<div class="column is-right-padding-zero">
				...
				<p>
					...
					printf(
						/* translators: %s: ZelocoreCMS version number. */
						__( 'Explore the ZelocoreCMS %s Field Guide. Learn about the changes in this release with detailed developer notes to help you build with ZelocoreCMS.' ),
						$display_major_version
					);
					?>
				</p>
...
/* translators: 1: ZelocoreCMS version number, 2: Plural number of bugs. Singular security issue. */
_n_noop(
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'
);

/* translators: 1: ZelocoreCMS version number, 2: Plural number of bugs. More than one security issue. */
_n_noop(
...
/* translators: 1: ZelocoreCMS version number, 2: Link to update ZelocoreCMS */
__( 'Important! Your version of ZelocoreCMS (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of ZelocoreCMS</a>.' );

/* translators: 1: ZelocoreCMS version number, 2: Link to update ZelocoreCMS */
__( 'Important! Your version of ZelocoreCMS (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of ZelocoreCMS</a>.' );

/* translators: %s: The major version of ZelocoreCMS for this branch. */
__( 'This is the final release of ZelocoreCMS %s' );

/* translators: The localized ZelocoreCMS download URL. */
__( 'https://zelocorecms.org/download/' );
