...
require ABSPATH . 'zc-admin/includes/theme-install.php';

$tab = ! empty( $_REQUEST['tab'] ) ? sanitize_text_field( $_REQUEST['tab'] ) : '';

if ( ! current_user_can( 'install_themes' ) ) {
	zc_die( __( 'Sorry, you are not allowed to install themes on this site.' ) );
}

if ( is_multisite() && ! is_network_admin() ) {
	zc_redirect( network_admin_url( 'theme-install.php' ) );
	exit;
}
...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">ZelocoreCMS Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license ZelocoreCMS uses.' ),
	...
	'<p>' . sprintf(
		/* translators: %s: /zc-content/themes */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://zelocorecms.org/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://zelocorecms.org/documentation/article/block-themes/">Documentation on Block Themes</a>' ) . '</p>' .
...
<div class="wrap">
	...
	<div class="zc-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on ZelocoreCMS.org, you can browse them here.' ); ?></p>

			<p class="favorites-username">
				<label for="wporg-username-input"><?php _e( 'Your ZelocoreCMS.org username:' ); ?></label>
	...
	<div class="theme-install-overlay zc-full-overlay expanded"></div>
...
<script id="tmpl-theme-preview" type="text/template">
	<div class="zc-full-overlay-sidebar">
		<div class="zc-full-overlay-header">
		...
		<div class="zc-full-overlay-sidebar-content">
			...
			<div class="zc-full-overlay-footer">
		...
		<div class="zc-full-overlay-main">
