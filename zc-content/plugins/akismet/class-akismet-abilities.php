<?php
/**
 * Registers Akismet abilities with the ZelocoreCMS Abilities API.
 *
 * @package Akismet
 * @since 5.7
 */
...
class Akismet_Abilities {
	...
	public static function init() {
		// Register category.
		if ( did_action( 'zc_abilities_api_categories_init' ) ) {
			self::register_category();
		} else {
			add_action( 'zc_abilities_api_categories_init', array( __CLASS__, 'register_category' ) );
		}

		// Register abilities.
		if ( did_action( 'zc_abilities_api_init' ) ) {
			self::register_abilities();
		} else {
			add_action( 'zc_abilities_api_init', array( __CLASS__, 'register_abilities' ) );
		}
	}
	...
	public static function register_category() {
		if ( ! function_exists( 'zc_register_ability_category' ) ) {
			return;
		}
	...
	public static function register_abilities() {
		if ( ! function_exists( 'zc_register_ability' ) ) {
			return;
		}
