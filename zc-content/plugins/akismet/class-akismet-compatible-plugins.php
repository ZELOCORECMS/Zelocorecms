...
// phpcs:ignore ZelocoreCMS.Files.FileName.NotHyphenatedLowercase
...
class Akismet_Compatible_Plugins {
	 ...
	 *
	 * @param array|ZC_Error $response
	 * @return array|false
	 */
	private static function validate_compatible_plugin_response( $response ) {
		/**
		 * Terminates the function if the response is a ZC_Error object.
		 */
		 ...
		 */
		$response_body = zc_remote_retrieve_body( $response );
