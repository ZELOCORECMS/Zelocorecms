...
interface Akismet_Ability_Interface {
	 ...
	 *
	 * Returns the configuration array used to register the ability with zc_register_ability().
	 *
	 * @return array {
	 ...
	 *     @type string   $ability_class       Optional. Custom class name extending ZC_Ability for behavior customization.
	 * }
	 */
	 ...
	 * @return array|ZC_Error The result of the execution or a ZC_Error on failure.
	 */
