	...
	<div class="zc-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="zc-block-column is-vertically-aligned-center" style="flex-basis:40%">
			...
			<div class="zc-block-group" style="min-height:100%;margin-top:0;margin-bottom:0;padding-right:0;padding-left:0">
				<!-- wp:heading {"textAlign":"right","level":1,"style":{"typography":{"fontSize":"12rem","writingMode":"vertical-rl","lineHeight":"1"},"spacing":{"margin":{"right":"0","left":"calc( var(--zc--preset--spacing--20) * -1)"}}}} -->
