...
<div class="zc-block-query"><!-- wp:post-template -->
...
<div class="zc-block-columns" style="border-top-color:var(--zc--preset--color--accent-6);border-top-width:1px;padding-top:var(--zc--preset--spacing--50);padding-bottom:var(--zc--preset--spacing--50)"><!-- wp:column {"width":"20%"} -->
<div class="zc-block-column" style="flex-basis:20%"><!-- wp:post-date {"isLink":true} /--></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="zc-block-column"><!-- wp:post-title /-->
...
<!-- wp:column {"width":"20%"} -->
<div class="zc-block-column" style="flex-basis:20%"><!-- wp:post-featured-image {"aspectRatio":"1"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- /wp:post-template -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"default"}} -->
<div class="zc-block-group" style="padding-top:var(--zc--preset--spacing--40);padding-bottom:var(--zc--preset--spacing--40)"><!-- wp:query-pagination {"paginationArrow":"arrow","layout":{"type":"flex","justifyContent":"space-between"}} -->
