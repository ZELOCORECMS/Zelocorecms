...
<div class="zc-block-cover alignfull has-accent-1-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--zc--preset--spacing--50);padding-right:var(--zc--preset--spacing--50);padding-bottom:var(--zc--preset--spacing--50);padding-left:var(--zc--preset--spacing--50);min-height:100vh"><span aria-hidden="true" class="zc-block-cover__background has-contrast-background-color has-background-dim-30 has-background-dim"></span><img class="zc-block-cover__image-background" alt="<?php esc_attr_e( 'Picture of a historical building in ruins.', 'twentytwentyfive' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/poster-image-background.webp" data-object-fit="cover"/>
<div class="zc-block-cover__inner-container">
	<!-- zc:group {"align":"wide","style":{"dimensions":{"minHeight":"100vh"}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between","justifyContent":"stretch"}} -->
	<div class="zc-block-group alignwide" style="min-height:100vh">
		<!-- zc:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|50"}}}} -->
		<div class="zc-block-columns alignwide">
			<!-- zc:column {"width":"80%"} -->
			<div class="zc-block-column" style="flex-basis:80%">
				<!-- zc:heading {"textAlign":"left","align":"wide","style":{"typography":{"fontSize":"12vw","lineHeight":"0.9","fontStyle":"normal","fontWeight":"300"}}} -->
				<h2 class="zc-block-heading alignwide has-text-align-left" style="font-size:12vw;font-style:normal;font-weight:300;line-height:0.9">
					<?php
					echo zc_kses_post(
		...
		<!-- zc:columns {"verticalAlignment":"bottom","isStackedOnMobile":false,"align":"wide"} -->
		<div class="zc-block-columns alignwide are-vertically-aligned-bottom is-not-stacked-on-mobile">
			<!-- zc:column {"verticalAlignment":"bottom","width":"80%"} -->
			<div class="zc-block-column is-vertically-aligned-bottom" style="flex-basis:80%">
				<!-- zc:heading {"textAlign":"left","align":"wide","style":{"typography":{"lineHeight":"0.9","fontStyle":"normal","fontWeight":"300"}},"fontSize":"xx-large"} -->
				<h2 class="zc-block-heading alignwide has-text-align-left has-xx-large-font-size" style="font-style:normal;font-weight:300;line-height:0.9"><?php esc_html_e( 'Let’s hear them.', 'twentytwentyfive' ); ?></h2>
				<!-- /zc:heading -->
			</div>
			<!-- /zc:column -->

			<!-- zc:column {"verticalAlignment":"bottom","width":"20%"} -->
			<div class="zc-block-column is-vertically-aligned-bottom" style="flex-basis:20%">
				<!-- zc:paragraph {"align":"right"} -->
