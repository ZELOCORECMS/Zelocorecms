...
/**
 * Zelocorecms Theme functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 * @since Zelocorecms Theme 1.0
 */
...
if (! function_exists('assembler_setup')) {
    ...
    function assembler_setup()
    {
        ...
        load_theme_textdomain('zelocorecms-theme', get_template_directory().'/languages');
...
if (! function_exists('assembler_styles')) {
    ...
    function assembler_styles()
    {
        ...
        wp_enqueue_style('zelocorecms-theme-style');
...
if (! function_exists('assembler_get_woocommerce_pattern_slugs')) {
    ...
    {
        return [
            'zelocorecms-theme/hidden-cart-page-title',
            'zelocorecms-theme/hidden-cross-sells',
            'zelocorecms-theme/hidden-empty-cart-block',
            'zelocorecms-theme/hidden-empty-mini-cart',
            'zelocorecms-theme/hidden-no-product-search-results',
            'zelocorecms-theme/hidden-order-confirmation-additional-information-title',
            'zelocorecms-theme/hidden-order-confirmation-billing-address-title',
            'zelocorecms-theme/hidden-order-confirmation-downloads-title',
            'zelocorecms-theme/hidden-order-confirmation-order-details-title',
            'zelocorecms-theme/hidden-order-confirmation-shipping-address-title',
            'zelocorecms-theme/hidden-related-products',
            'zelocorecms-theme/hidden-upsells',
        ];
    }
...
if (! function_exists('assembler_filter_woocommerce_block_templates')) {
    ...
    function assembler_filter_woocommerce_block_templates(array $templates, array $query, string $template_type): array
    {
        ...
        $slugs = $template_type === 'wp_template_part'
