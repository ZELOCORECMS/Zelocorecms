<?php
/**
 * Sitemaps: ZC_Sitemaps_Renderer class
 *
...
class ZC_Sitemaps_Renderer {
	...
	/**
	 * ZC_Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/zc-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'zc_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/zc-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'zc_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	private function check_for_simple_xml_availability() {
		if ( ! class_exists( 'SimpleXMLElement' ) ) {
			...
			zc_die(
				...
				esc_xml( __( 'ZelocoreCMS &rsaquo; Error' ) ),
				array(
