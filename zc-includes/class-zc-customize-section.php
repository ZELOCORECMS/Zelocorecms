<?php
/**
 * ZelocoreCMS Customize Section classes
 *
 * @package ZelocoreCMS
 ...
 *
 * A UI container for controls, managed by the ZC_Customize_Manager class.
 *
 * @since 3.4.0
 *
...
class ZC_Customize_Section {
	...
	final public function active() {
		...
		/**
		 * Filters response of ZC_Customize_Section::active().
		 *
		 * @since 4.1.0
		 *
		 * @param bool                 $active  Whether the Customizer section is active.
		 * @param ZC_Customize_Section $section ZC_Customize_Section instance.
		 */
	...
	/**
	 * Default callback used when invoking ZC_Customize_Section::active().
	 *
	...
	public function json() {
		$array                   = zc_array_slice_assoc( (array) $this, array( 'id', 'description', 'priority', 'panel', 'type', 'description_hidden' ) );
	 ...
	 *
	 * Sections are now rendered in JS by default, see ZC_Customize_Section::print_template().
	 *
	 * @since 3.4.0
	 */
	 ...
	 * ZC_Customize_Manager::register_section_type().
	 *
	 * @since 4.3.0
	 *
	 * @see ZC_Customize_Manager::render_template()
	 */
	 ...
	 * export custom variables by overriding ZC_Customize_Section::json().
	 *
	 * @since 4.3.0
	 *
	 * @see ZC_Customize_Section::print_template()
	 */
