<?php
/**
 * Style Engine: ZC_Style_Engine_CSS_Declarations class
 *
 * @package ZelocoreCMS
...
class ZC_Style_Engine_CSS_Declarations {
	 ...
	 * @return ZC_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
	 */
	...
	protected static function filter_declaration( $property, $value, $spacer = '' ) {
		$filtered_value = zc_strip_all_tags( $value, true );
		if ( '' !== $filtered_value ) {
