<?php
/**
 * Style Engine: ZC_Style_Engine_CSS_Rules_Store class
 *
 * @package ZelocoreCMS
...
/**
 * Core class used as a store for ZC_Style_Engine_CSS_Rule objects.
 *
...
class ZC_Style_Engine_CSS_Rules_Store {

	/**
	 * An array of named ZC_Style_Engine_CSS_Rules_Store objects.
	 *
	 * @static
	 *
	 * @since 6.1.0
	 ...
	 * @return ZC_Style_Engine_CSS_Rules_Store|void
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return ZC_Style_Engine_CSS_Rules_Store[]
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return ZC_Style_Engine_CSS_Rule[]
	 */
	...
	/**
	 * Gets a ZC_Style_Engine_CSS_Rule object by its selector.
	 ...
	 * @return ZC_Style_Engine_CSS_Rule|void Returns a ZC_Style_Engine_CSS_Rule object,
	...
	public function add_rule( $selector, $rules_group = '' ) {
		...
		if ( ! empty( $rules_group ) ) {
			if ( empty( $this->rules[ "$rules_group $selector" ] ) ) {
				$this->rules[ "$rules_group $selector" ] = new ZC_Style_Engine_CSS_Rule( $selector, array(), $rules_group );
			}
		...
		if ( empty( $this->rules[ $selector ] ) ) {
			$this->rules[ $selector ] = new ZC_Style_Engine_CSS_Rule( $selector );
		}
