...
function render_block_core_accordion( $attributes, $content ) {
	...
	if ( $p->next_tag( array( 'class_name' => 'zc-block-accordion' ) ) ) {
		$p->set_attribute( 'data-zc-interactive', 'core/accordion' );
		$p->set_attribute( 'data-zc-context', '{ "autoclose": ' . $autoclose . ', "accordionItems": [] }' );
