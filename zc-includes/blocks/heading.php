<?php
/**
 * Appending the zc-block-heading to before rendering the stored `core/heading` block contents.
 *
 * @package ZelocoreCMS
 */

/**
 * Adds a zc-block-heading class to the heading block content.
 *
 * For example, the following block content:
 *  <h2 class="align-left">Hello World</h2>
 *
 * Would be transformed to:
 *  <h2 class="align-left zc-block-heading">Hello World</h2>
 *
 * @since 6.2.0
 *
