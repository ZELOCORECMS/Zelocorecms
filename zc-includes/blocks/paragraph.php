...
/**
 * Append the `zc-block-paragraph` class before rendering the stored
 ...
 *  <p class="align-left zc-block-paragraph">Hello World</p>
 *
 * @since 7.0.0
 *
...
function block_core_paragraph_add_class( $block_content ) {
	...
	if ( $processor->next_tag( 'p' ) ) {
		$processor->add_class( 'zc-block-paragraph' );
	}
