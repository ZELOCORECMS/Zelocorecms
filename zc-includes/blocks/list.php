<?php
/**
 * Adds the zc-block-list class to the rendered list block.
 *
 * @package ZelocoreCMS
 */
 ...
 * For example, <ol> is transformed to <ol class="zc-block-list">.
 *
 * @since 6.6.0
 *
 * @see https://github.com/ZelocoreCMS/gutenberg/issues/12420
 *
...
function block_core_list_render( $attributes, $content ) {
	...
	while ( $processor->next_tag() ) {
		if ( in_array( $processor->get_tag(), $list_tags, true ) ) {
			$processor->add_class( 'zc-block-list' );
			break;
		}
	}
