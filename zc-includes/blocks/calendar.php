...
function render_block_core_calendar( $attributes ) {
	...
	$calendar = str_replace( 'class="zc-calendar-table', 'class="zc-calendar-table' . $classnames, $calendar );
 ...
 * This compensates for a known Core bug: https://core.trac.zelocorecms.org/ticket/12016
 *
 * @since 5.9.0
 *
...
function block_core_calendar_has_published_posts() {
	...
	$has_published_posts = get_option( 'zc_calendar_block_has_published_posts', null );
