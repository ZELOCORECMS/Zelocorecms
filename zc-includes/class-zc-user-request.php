<?php
/**
 * ZC_User_Request class.
 *
 * Represents user request data loaded from a ZC_Post object.
 *
 * @since 4.9.6
 */
#[AllowDynamicProperties]
final class ZC_User_Request {
	/**
	 * Request ID.
	 *
	 * @since 4.9.6
	 ...
	 *
	 * @since 4.9.6
	 * @since 6.8.0 The key is now hashed using zc_fast_hash() instead of phpass.
	 *
	 * @var string
	 */
	public $confirm_key = '';
	 ...
	 * @since 4.9.6
	 *
	 * @param ZC_Post|object $post Post object.
	 */
	public function __construct( $post ) {
		...
		$this->confirmed_timestamp = (int) get_post_meta( $post->ID, '_zc_user_request_confirmed_timestamp', true );
		$this->completed_timestamp = (int) get_post_meta( $post->ID, '_zc_user_request_completed_timestamp', true );
