 ...
 * ZelocoreCMS PHPMailer class.
 *
 * Overrides the internationalization method in order to use ZelocoreCMS' instead.
 *
 * @since 6.8.0
 */
class ZC_PHPMailer extends PHPMailer\PHPMailer\PHPMailer {
	...
	/**
	 * Defines the error messages using ZelocoreCMS' internationalization method.
	 *
	 * @since 6.8.0
	 *
