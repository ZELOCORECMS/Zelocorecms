...
/**
 * Icons API: ZC_Icons_Registry class
 *
 * @package ZelocoreCMS
 * @since 7.0.0
 */
...
class ZC_Icons_Registry {
	 ...
	 * Constructor.
	 *
	 * ZC_Icons_Registry is a singleton class, so keep this protected.
	 *
	 * For 7.0, the Icons Registry is closed for third-party icon registry,
	 * serving only a subset of core icons.
	 *
	 * These icons are defined in @zelocorecms/packages (Gutenberg repository) as
	...
	protected function sanitize_icon_content( $icon_content ) {
		...
		return zc_kses( $icon_content, $allowed_tags );
	}
	 ...
	 *
	 *
	 * @return ZC_Icons_Registry The main instance.
	 */
