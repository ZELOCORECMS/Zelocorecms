...
final class ZC_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $hook_name, $callback, $priority, $accepted_args ) {
		...
		$idx = _zc_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function remove_filter( $hook_name, $callback, $priority ) {
		...
		$function_key = _zc_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function has_filter( $hook_name = '', $callback = false, $priority = false ) {
		...
		$function_key = _zc_filter_build_unique_id( $hook_name, $callback, false );
	...
	/**
	 * Normalizes filters set up before ZelocoreCMS has initialized to ZC_Hook objects.
	 *
	 ...
	 * @return ZC_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var ZC_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $hook_name => $callback_groups ) {
			if ( $callback_groups instanceof ZC_Hook ) {
