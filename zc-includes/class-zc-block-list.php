<?php
/**
 * Blocks API: ZC_Block_List class
 *
 * @package ZelocoreCMS
 * @since 5.5.0
 */
...
class ZC_Block_List implements Iterator, ArrayAccess, Countable {
	 ...
	 * @since 5.5.0
	 *
	 * @param array[]|ZC_Block[]     $blocks            Array of parsed block data, or block instances.
	...
	public function __construct( $blocks, $available_context = array(), $registry = null ) {
		if ( ! $registry instanceof ZC_Block_Type_Registry ) {
	 ...
	 * @return ZC_Block|null Block value if exists, or null.
	 */
	#[ReturnTypeWillChange]
	public function offsetGet( $offset ) {
		...
		if ( isset( $block ) && is_array( $block ) ) {
			$block = new ZC_Block( $block, $this->available_context, $this->registry );
	 ...
	 * @param array|ZC_Block $value  Block value.
	 */
	#[ReturnTypeWillChange]
	 ...
	 *
	 * @return ZC_Block|null Current element.
	 */
	#[ReturnTypeWillChange]
