...
if (typeof document !== "undefined" && !document.head.querySelector("style[data-zc-hash='71d20935c2']")) {
  const style = document.createElement("style");
  style.setAttribute("data-zc-hash", "71d20935c2");
  style.appendChild(document.createTextNode("@layer zc-ui-utilities, zc-ui-components, zc-ui-compositions, zc-ui-overrides;@layer zc-ui-components{._19ce0419607e1896__stack{display:flex}}"));
  document.head.appendChild(style);
}
...
import { speak } from "@zelocorecms/a11y";
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
if (typeof document !== "undefined" && !document.head.querySelector("style[data-zc-hash='671ebfc62d']")) {
  const style = document.createElement("style");
  style.setAttribute("data-zc-hash", "671ebfc62d");
  style.appendChild(document.createTextNode("@layer zc-ui-utilities, zc-ui-components, zc-ui-compositions, zc-ui-overrides;@layer zc-ui-utilities{._336cd3e4e743482f__box-sizing{box-sizing:border-box;*,:after,:before{box-sizing:inherit}}}"));
  document.head.appendChild(style);
}
var resets_default = { "box-sizing": "_336cd3e4e743482f__box-sizing" };
if (typeof document !== "undefined" && !document.head.querySelector("style[data-zc-hash='a66a881fc5']")) {
  const style = document.createElement("style");
  style.setAttribute("data-zc-hash", "a66a881fc5");
  style.appendChild(document.createTextNode("@layer zc-ui-utilities, zc-ui-components, zc-ui-compositions, zc-ui-overrides;@layer zc-ui-components{._4145abab73d17514__notice{--icon-height:24px;--text-vertical-padding:calc((var(--icon-height) - var(--wpds-font-line-height-sm, 20px))/2);--zc-ui-notice-background-color:var(--wpds-color-bg-surface-neutral-weak,#f0f0f0);--zc-ui-notice-border-color:var(--wpds-color-stroke-surface-neutral,#d8d8d8);--zc-ui-notice-text-color:var(--wpds-color-fg-content-neutral,#1e1e1e);--zc-ui-notice-decorative-icon-color:var(--wpds-color-fg-content-neutral,#1e1e1e);align-items:start;background-color:var(--zc-ui-notice-background-color);border:1px solid var(--zc-ui-notice-border-color);border-radius:var(--wpds-border-radius-lg,8px);container-type:inline-size;display:grid;grid-template-columns:auto 1fr auto;padding:var(--wpds-dimension-padding-md,12px)}.d0a25570cb528528__icon{color:var(--zc-ui-notice-decorative-icon-color);grid-column:1;grid-row:1;margin-inline-end:var(--wpds-dimension-gap-xs,4px)}._1904b570a89bb815__description{text-wrap:pretty;color:var(--zc-ui-notice-text-color);grid-column:2;padding-block:var(--text-vertical-padding)}._531c140826094795__is-info{--zc-ui-notice-background-color:var(--wpds-color-bg-surface-info-weak,#f2f9ff);--zc-ui-notice-border-color:var(--wpds-color-stroke-surface-info,#9fbcdc);--zc-ui-notice-text-color:var(--wpds-color-fg-content-info,#001b4f);--zc-ui-notice-decorative-icon-color:var(--wpds-color-fg-content-info-weak,#006bd7)}.ae2e1004697cce95__is-warning{--zc-ui-notice-background-color:var(--wpds-color-bg-surface-warning-weak,#fff7e0);--zc-ui-notice-border-color:var(--wpds-color-stroke-surface-warning,#d0b381);--zc-ui-notice-text-color:var(--wpds-color-fg-content-warning,#2e1900);--zc-ui-notice-decorative-icon-color:var(--wpds-color-fg-content-warning-weak,#926300)}._2e614a76af494837__is-success{--zc-ui-notice-background-color:var(--wpds-color-bg-surface-success-weak,#eaffed);--zc-ui-notice-border-color:var(--wpds-color-stroke-surface-success,#8ac894);--zc-ui-notice-text-color:var(--wpds-color-fg-content-success,#002900);--zc-ui-notice-decorative-icon-color:var(--wpds-color-fg-content-success-weak,#007f30)}.af00331ae17a0065__is-error{--zc-ui-notice-background-color:var(--wpds-color-bg-surface-error-weak,#fff6f4);--zc-ui-notice-border-color:var(--wpds-color-stroke-surface-error,#daa39b);--zc-ui-notice-text-color:var(--wpds-color-fg-content-error,#470000);--zc-ui-notice-decorative-icon-color:var(--wpds-color-fg-content-error-weak,#cc1818)}}"));
  document.head.appendChild(style);
}
...
} from "@zelocorecms/connectors";

// routes/connectors-home/style.scss
if (typeof document !== "undefined" && !document.head.querySelector("style[data-zc-hash='eb5f96e519']")) {
  const style = document.createElement("style");
  style.setAttribute("data-zc-hash", "eb5f96e519");
...
var { lock, unlock } = (0, import_private_apis.__dangerousOptInToUnstableAPIsOnlyForCoreModules)(
  "I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of ZelocoreCMS.",
  "@zelocorecms/routes"
);
  ...
  try {
    return JSON.parse(
      document.getElementById(
        "zc-script-module-data-options-connectors-zc-admin"
      )?.textContent ?? "{}"
    );
  } catch {
    return {};
...
var PluginDirectoryLink = ({ slug }) => /* @__PURE__ */ React.createElement(
  import_components2.ExternalLink,
  {
    href: (0, import_i18n2.sprintf)(
      ...
      (0, import_i18n2.__)("https://zelocorecms.org/plugins/%s/"),
      slug
    )
  },
...
// routes/connectors-home/zc-logo-decoration.tsx
...
var AI_PLUGIN_PAGE_SLUG = "ai-zc-admin";
var AI_PLUGIN_ID = "ai/ai";
var AI_PLUGIN_URL = "https://zelocorecms.org/plugins/ai/";
