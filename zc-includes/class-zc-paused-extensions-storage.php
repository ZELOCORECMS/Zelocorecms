<?php
/**
 * Error Protection API: ZC_Paused_Extensions_Storage class
 *
 * @package ZelocoreCMS
 * @since 5.2.0
 */
...
class ZC_Paused_Extensions_Storage {
	...
	protected function get_option_name() {
		if ( ! zc_recovery_mode()->is_active() ) {
			return '';
		}

		$session_id = zc_recovery_mode()->get_session_id();
		if ( empty( $session_id ) ) {
			return '';
		}
