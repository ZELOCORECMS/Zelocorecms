...
class ZC_Ability {
	 ...
	 *
	 * @since 6.9.0
	 * @var callable(mixed): (mixed|ZC_Error)
	 */
	 ...
	 *
	 * @since 6.9.0
	 * @var callable(mixed): (bool|ZC_Error)
	 */
	 ...
	 * Constructor.
	 *
	 * Do not use this constructor directly. Instead, use the `zc_register_ability()` function.
	 *
	 * @access private
	 *
	 * @since 6.9.0
	 ...
	 *
	 * Errors are thrown as exceptions instead of ZC_Errors to allow for simpler handling and overloading. They are then
	 * caught and converted to a ZC_Error by ZC_Abilities_Registry::register().
	 *
	 * @since 6.9.0
	 *
	...
	protected function prepare_properties( array $args ): array {
		...
		$args['meta']['annotations'] = zc_parse_args(
	 ...
	 * @return true|ZC_Error Returns true if valid or the ZC_Error object if validation fails.
	 */
	 ...
	 * @return mixed The result of the callable execution, or a `ZC_Error` if the callback threw.
	 */
	 ...
	 * @return bool|ZC_Error Whether the ability has the necessary permission.
	 */
	 ...
	 *
	 * @param mixed $input Optional. The input data for the ability. Default `null`.
	 * @return mixed|ZC_Error The result of the ability execution, or ZC_Error on failure.
	 */
	 ...
	 * @return true|ZC_Error Returns true if valid, or a ZC_Error object if validation fails.
	 */
	...
	public function execute( $input = null ) {
		...
		if ( true !== $has_permissions ) {
			if ( is_zc_error( $has_permissions ) ) {
		 ...
		 */
		do_action( 'zc_before_execute_ability', $this->name, $input );
		 ...
		 */
		do_action( 'zc_after_execute_ability', $this->name, $input, $result );
