 ...
 * Abilities API
 *
 * Defines ZC_Ability_Category class.
 *
 * @package ZelocoreCMS
 ...
 * @since 6.9.0
 *
 * @see ZC_Ability_Categories_Registry
 */
final class ZC_Ability_Category {
	 ...
	 * Constructor.
	 *
	 * Do not use this constructor directly. Instead, use the `zc_register_ability_category()` function.
	 *
	 * @access private
	 *
	 * @since 6.9.0
