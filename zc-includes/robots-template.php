 ...
 * {@see 'zc_robots'} filter. The directives are then sanitized, and the
...
function zc_robots() {
	 ...
	 */
	$robots = apply_filters( 'zc_robots', array() );
 ...
 * {@see 'zc_robots'} filter.
 *
 * Typical usage is as a {@see 'zc_robots'} callback:
 *
 *     add_filter( 'zc_robots', 'zc_robots_noindex' );
 *
 * @since 5.7.0
 *
 * @see zc_robots_no_robots()
 *
 * @param array $robots Associative array of robots directives.
 * @return array Filtered robots directives.
 */
function zc_robots_noindex( array $robots ) {
	if ( ! get_option( 'blog_public' ) ) {
		return zc_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function zc_robots_noindex_embeds( array $robots ) {
	if ( is_embed() ) {
		return zc_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function zc_robots_noindex_search( array $robots ) {
	if ( is_search() ) {
		return zc_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function zc_robots_no_robots( array $robots ) {
	$robots['noindex'] = true;
 ...
 * @return array Filtered robots directives.
 */
function zc_robots_sensitive_page( array $robots ) {
	$robots['noindex']   = true;
 ...
 * @return array Filtered robots directives.
 */
function zc_robots_max_image_preview_large( array $robots ) {
	if ( get_option( 'blog_public' ) ) {
