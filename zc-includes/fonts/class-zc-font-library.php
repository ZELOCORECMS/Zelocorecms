...
class ZC_Font_Library {
	 ...
	 * @return ZC_Font_Collection|ZC_Error A font collection if it was registered successfully,
	 *                                     or ZC_Error object on failure.
	 */
	public function register_font_collection( string $slug, array $args ) {
		$new_collection = new ZC_Font_Collection( $slug, $args );
		...
		if ( $this->is_collection_registered( $new_collection->slug ) ) {
			...
			return new ZC_Error( 'font_collection_registration_error', $error_message );
		}
	 ...
	 *
	 * @param string $slug Font collection slug.
	 * @return ZC_Font_Collection|null Font collection object, or null if the font collection doesn't exist.
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @return ZC_Font_Library The main instance.
	 */
