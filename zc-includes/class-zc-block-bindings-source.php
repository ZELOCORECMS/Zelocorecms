<?php
/**
 * Block Bindings API: ZC_Block_Bindings_Source class.
 *
 * @package ZelocoreCMS
 ...
 * @access private
 *
 * @see ZC_Block_Bindings_Registry
 */
final class ZC_Block_Bindings_Source {
	 ...
	 * `ZC_Block_Bindings_Registry::register` method or the `register_block_bindings_source` function.
	 *
	 * @since 6.5.0
	 *
