<?php
/**
 * Feed API: ZC_Feed_Cache_Transient class
 *
 * @package ZelocoreCMS
 * @subpackage Feed
 * @since 4.7.0
...
class ZC_Feed_Cache_Transient implements SimplePie\Cache\Base {
	...
	public function __construct( $location, $name, $type ) {
		 ...
		 */
		$this->lifetime = apply_filters( 'zc_feed_cache_transient_lifetime', $lifetime, $name );
	}
