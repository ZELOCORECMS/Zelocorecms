<?php
/**
 * Locale API: ZC_Locale_Switcher class
 *
 * @package ZelocoreCMS
 * @subpackage i18n
 * @since 4.7.0
...
class ZC_Locale_Switcher {
	...
	/**
	 * Filters the locale of the ZelocoreCMS installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the ZelocoreCMS installation.
	 ...
	 *
	 * Loads the translations, changes the global `$zc_locale` object and updates
	...
	private function change_locale( $locale ) {
		global $zc_locale, $phpmailer;

		$this->load_translations( $locale );

		$zc_locale = new ZC_Locale();

		ZC_Translation_Controller::get_instance()->set_locale( $locale );

		if ( $phpmailer instanceof ZC_PHPMailer ) {
