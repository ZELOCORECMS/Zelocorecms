<?php
/**
 * HTTP API: ZC_HTTP_Requests_Response class
 *
 * @package ZelocoreCMS
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see ZC_HTTP_Response
 */
class ZC_HTTP_Requests_Response extends ZC_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return ZC_Http_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new ZC_Http_Cookie(
				array(
					'name'      => $cookie->name,
	...
	/**
	 * Converts the object to a ZC_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array ZC_Http response array, per ZC_Http::request().
	 */
