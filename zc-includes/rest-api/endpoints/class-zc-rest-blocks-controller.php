<?php
/**
 * Synced patterns REST API: ZC_REST_Blocks_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 5.0.0
 ...
 * Patterns are stored as posts with the zc_block post type.
 *
 * @since 5.0.0
 *
 ...
 */
class ZC_REST_Blocks_Controller extends ZC_REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param ZC_Post $post Post object that backs the block.
	 ...
	 *
	 * @since 5.0.0
	 * @since 6.3.0 Adds the `zc_pattern_sync_status` postmeta property to the top level of response.
	 *
	...
	public function filter_response_by_context( $data, $context ) {
		...
		// Add the core zc_pattern_sync_status meta as top level property to the response.
		$data['zc_pattern_sync_status'] = $data['meta']['zc_pattern_sync_status'] ?? '';
		unset( $data['meta']['zc_pattern_sync_status'] );
		return $data;
	}
