 ...
 */
class ZC_REST_Abilities_V1_Run_Controller extends ZC_REST_Controller {
	...
	public function register_routes(): void {
		register_rest_route(
			...
			array(
				...
				// exist or their annotations (`destructive`, `idempotent`, `readonly`). This is due to ZelocoreCMS
				...
				array(
					'methods'             => ZC_REST_Server::ALLMETHODS,
	 ...
	 * @return true|ZC_Error True on success, or ZC_Error object on failure.
	 */
	 ...
	 *
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return true|ZC_Error True if the request has execution permission, ZC_Error object otherwise.
	 */
