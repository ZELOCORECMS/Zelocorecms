<?php
/**
 * REST API: ZC_REST_Block_Patterns_Controller class
 *
 * @package    ZelocoreCMS
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class ZC_REST_Block_Patterns_Controller extends ZC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response = array();
		$patterns = ZC_Block_Patterns_Registry::get_instance()->get_all_registered();
