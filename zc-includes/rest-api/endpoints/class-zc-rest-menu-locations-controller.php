<?php
/**
 * REST API: ZC_REST_Menu_Locations_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 5.9.0
 ...
 */
class ZC_REST_Menu_Locations_Controller extends ZC_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( ! array_key_exists( $request['location'], $registered_menus ) ) {
			return new ZC_Error( 'rest_menu_location_invalid', __( 'Invalid menu location.' ), array( 'status' => 404 ) );
		}
	 ...
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return ZC_REST_Response Menu location data.
	 */
