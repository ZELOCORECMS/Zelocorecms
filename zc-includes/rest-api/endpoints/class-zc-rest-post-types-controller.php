<?php
/**
 * REST API: ZC_REST_Post_Types_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class ZC_REST_Post_Types_Controller extends ZC_REST_Controller {
	 ...
	 *
	 * @param ZC_Post_Type    $item    Post type object.
	 * @param ZC_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( $request->is_method( 'HEAD' ) ) {
			/** This filter is documented in zc-includes/rest-api/endpoints/class-zc-rest-post-types-controller.php */
			return apply_filters( 'rest_prepare_post_type', new ZC_REST_Response( array() ), $post_type, $request );
		}
		 ...
		 * @param ZC_Post_Type     $post_type The original post type object.
	 ...
	 * @since 6.1.0
	 *
	 * @param ZC_Post_Type $post_type The post type.
