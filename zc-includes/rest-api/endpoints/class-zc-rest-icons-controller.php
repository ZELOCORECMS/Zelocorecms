...
/**
 * REST API: ZC_REST_Icons_Controller class
 *
 * @package    ZelocoreCMS
 * @subpackage REST_API
 * @since      7.0.0
 ...
 * in a single manifest file (zc-includes/assets/icon-library-manifest.php).
 ...
 */
class ZC_REST_Icons_Controller extends ZC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$icons    = ZC_Icons_Registry::get_instance()->get_registered_icons( $search );
	 ...
	 * @return array|ZC_Error Icon data on success, or ZC_Error object on failure.
	 */
	public function get_icon( $name ) {
		$registry = ZC_Icons_Registry::get_instance();
