<?php
/**
 * Block Renderer REST API: ZC_REST_Block_Renderer_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class ZC_REST_Block_Renderer_Controller extends ZC_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				array(
					'methods'             => array( ZC_REST_Server::READABLE, ZC_REST_Server::CREATABLE ),
					...
					'args'                => array(
						...
						'attributes' => array(
							...
							'validate_callback' => static function ( $value, $request ) {
								$block = ZC_Block_Type_Registry::get_instance()->get_registered( $request['name'] );
