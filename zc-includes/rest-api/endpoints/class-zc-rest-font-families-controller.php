<?php
/**
 * REST API: ZC_REST_Font_Families_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 6.5.0
 ...
 * @since 6.5.0
 */
class ZC_REST_Font_Families_Controller extends ZC_REST_Posts_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param ZC_Post          $post     Font family post object.
		 * @param ZC_REST_Request  $request  Request object.
		 */
		return apply_filters( 'rest_prepare_zc_font_family', $response, $item, $request );
	}
	...
	public function get_collection_params() {
		 ...
		 */
		return apply_filters( 'rest_zc_font_family_collection_params', $query_params );
	}
	...
	public function get_endpoint_args_for_item_schema( $method = ZC_REST_Server::CREATABLE ) {
		if ( ZC_REST_Server::CREATABLE === $method || ZC_REST_Server::EDITABLE === $method ) {
