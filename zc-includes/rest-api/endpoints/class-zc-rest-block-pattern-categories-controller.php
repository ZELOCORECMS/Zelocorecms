<?php
/**
 * REST API: ZC_REST_Block_Pattern_Categories_Controller class
 *
 * @package    ZelocoreCMS
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class ZC_REST_Block_Pattern_Categories_Controller extends ZC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response   = array();
		$categories = ZC_Block_Pattern_Categories_Registry::get_instance()->get_all_registered();
