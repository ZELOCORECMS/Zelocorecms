 ...
 */
class ZC_REST_Abilities_V1_Categories_Controller extends ZC_REST_Controller {
	...
	public function get_items( $request ) {
		$categories = zc_get_ability_categories();
		...
		$response->header( 'X-ZC-Total', (string) $total_categories );
	...
	public function get_item( $request ) {
		$category = zc_get_ability_category( $request['slug'] );
		if ( ! $category ) {
			return new ZC_Error(
	 ...
	 * @since 6.9.0
	 *
	 * @param ZC_Ability_Category $category The ability category object.
