<?php
/**
 * REST API: ZC_REST_Post_Statuses_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class ZC_REST_Post_Statuses_Controller extends ZC_REST_Controller {
	 ...
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return ZC_REST_Response Post status data.
	 */
