<?php
/**
 * REST API: ZC_REST_Taxonomies_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class ZC_REST_Taxonomies_Controller extends ZC_REST_Controller {
	 ...
	 *
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return bool|ZC_Error True if the request has read access for the item, otherwise false or ZC_Error object.
	 */
	 ...
	 *
	 * @param ZC_Taxonomy     $item    Taxonomy data.
	 * @param ZC_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( $request->is_method( 'HEAD' ) ) {
			/** This filter is documented in zc-includes/rest-api/endpoints/class-zc-rest-taxonomies-controller.php */
			return apply_filters( 'rest_prepare_taxonomy', new ZC_REST_Response( array() ), $taxonomy, $request );
		}
		 ...
		 * @param ZC_Taxonomy      $item     The original taxonomy object.
	 ...
	 * @since 6.1.0
	 *
	 * @param ZC_Taxonomy $taxonomy The taxonomy.
