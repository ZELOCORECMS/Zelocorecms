<?php
/**
 * REST API: ZC_REST_Settings_Controller class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class ZC_REST_Settings_Controller extends ZC_REST_Controller {
	 ...
	 *
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return array|ZC_Error Array on success, or ZC_Error object on failure.
	 */
	 ...
	 *
	 * @param ZC_REST_Request $request Full details about the request.
	 * @return array|ZC_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_zc_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new ZC_Error(
