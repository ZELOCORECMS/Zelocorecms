<?php
/**
 * REST API: ZC_REST_Response class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class ZC_REST_Response extends ZC_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = zc_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a ZC_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return ZC_Error|null ZC_Error or null on not an errored response.
	 */
