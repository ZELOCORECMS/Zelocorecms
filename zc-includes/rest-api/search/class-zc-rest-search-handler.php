<?php
/**
 * REST API: ZC_REST_Search_Handler class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 5.0.0
...
abstract class ZC_REST_Search_Handler {
	 ...
	 * @return array Associative array containing an `ZC_REST_Search_Handler::RESULT_IDS` containing
	 *               an array of found IDs and `ZC_REST_Search_Handler::RESULT_TOTAL` containing the
	 *               total count for the matching search results.
	 */
	abstract public function search_items( ZC_REST_Request $request );
