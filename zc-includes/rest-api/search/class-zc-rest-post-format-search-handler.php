<?php
/**
 * REST API: ZC_REST_Post_Format_Search_Handler class
 *
 * @package ZelocoreCMS
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class ZC_REST_Post_Format_Search_Handler extends ZC_REST_Search_Handler {
	...
	public function prepare_item( $id, array $fields ) {
		...
		if ( in_array( ZC_REST_Search_Controller::PROP_ID, $fields, true ) ) {
			$data[ ZC_REST_Search_Controller::PROP_ID ] = $id;
		}

		if ( in_array( ZC_REST_Search_Controller::PROP_TITLE, $fields, true ) ) {
			$data[ ZC_REST_Search_Controller::PROP_TITLE ] = get_post_format_string( $id );
		}

		if ( in_array( ZC_REST_Search_Controller::PROP_URL, $fields, true ) ) {
			$data[ ZC_REST_Search_Controller::PROP_URL ] = get_post_format_link( $id );
		}
