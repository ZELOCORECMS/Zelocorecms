 ...
 * @since 6.9.0
 */
function zc_register_core_ability_categories(): void {
...
function zc_register_core_abilities(): void {
	...
	$site_info_properties = array(
		...
		'wpurl'       => array(
			'type'        => 'string',
			'description' => __( 'The ZelocoreCMS installation URL.' ),
		),
		'admin_email' => array(
			'type'        => 'string',
		...
		'version'     => array(
			'type'        => 'string',
			'description' => __( 'The ZelocoreCMS version.' ),
		),
	);
	...
	zc_register_ability(
		...
		array(
			...
			'description'         => __( 'Returns site information configured in ZelocoreCMS. By default returns all fields, or optionally a filtered subset.' ),
	...
	zc_register_ability(
		...
		array(
			...
			'description'         => __( 'Returns core details about the site\'s runtime context for diagnostics and compatibility (environment, PHP runtime, database server info, ZelocoreCMS version).' ),
			'category'            => $category_site,
			'output_schema'       => array(
				'type'                 => 'object',
				'required'             => array( 'environment', 'php_version', 'db_server_info', 'zc_version' ),
				'properties'           => array(
					'environment'    => array(
						'type'        => 'string',
					...
					'php_version'    => array(
						'type'        => 'string',
						'description' => __( 'The PHP runtime version executing ZelocoreCMS.' ),
					),
					...
					'zc_version'     => array(
						'type'        => 'string',
						'description' => __( 'The ZelocoreCMS core version running on this site.' ),
					),
				),
				'additionalProperties' => false,
			),
