...
<div class="zc-block-group alignwide" style="padding-top:var(--zc--preset--spacing--30);padding-right:var(--zc--preset--spacing--30);padding-bottom:var(--zc--preset--spacing--30);padding-left:var(--zc--preset--spacing--30)"><!-- wp:navigation {"style":{"typography":{"lineHeight":"1"}},"fontSize":"xx-large","layout":{"type":"flex","orientation":"vertical"}} /-->
