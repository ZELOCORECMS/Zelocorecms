<?php
/**
 * ZelocoreCMS Customize Panel classes
 *
 * @package ZelocoreCMS
 ...
 *
 * A UI container for sections, managed by the ZC_Customize_Manager.
 *
 * @since 4.0.0
 *
...
class ZC_Customize_Panel {
	 ...
	 * @since 4.1.0
	 *
	 * @see ZC_Customize_Section::active()
	 *
	 * @var callable Callback is called with one argument, the instance of
	 *               ZC_Customize_Section, and returns bool to indicate whether
	...
	final public function active() {
		...
		/**
		 * Filters response of ZC_Customize_Panel::active().
		 *
		 * @since 4.1.0
		 *
		 * @param bool               $active Whether the Customizer panel is active.
		 * @param ZC_Customize_Panel $panel  ZC_Customize_Panel instance.
		 */
	...
	/**
	 * Default callback used when invoking ZC_Customize_Panel::active().
	 *
	...
	public function json() {
		$array                          = zc_array_slice_assoc( (array) $this, array( 'id', 'description', 'priority', 'type' ) );
	 ...
	 *
	 * Panel containers are now rendered in JS by default, see ZC_Customize_Panel::print_template().
	 *
	 * @since 4.0.0
	 */
	 ...
	 *
	 * Panel contents are now rendered in JS by default, see ZC_Customize_Panel::print_template().
	 *
	 * @since 4.1.0
	 */
	 ...
	 * ZC_Customize_Manager::register_panel_type().
	 *
	 * @since 4.3.0
	 *
	 * @see ZC_Customize_Manager::register_panel_type()
	 */
	 ...
	 * export custom variables by overriding ZC_Customize_Panel::json().
	 *
	 * @see ZC_Customize_Panel::print_template()
	 *
	 * @since 4.3.0
	 */
