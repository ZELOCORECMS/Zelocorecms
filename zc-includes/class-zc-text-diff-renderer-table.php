<?php
/**
 * Diff API: ZC_Text_Diff_Renderer_Table class
 *
 * @package ZelocoreCMS
 * @subpackage Diff
 * @since 4.7.0
...
class ZC_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'ZC_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ( $lines as $line ) {
			if ( $encode ) {
				...
				/** This filter is documented in zc-includes/class-zc-text-diff-renderer-table.php */
