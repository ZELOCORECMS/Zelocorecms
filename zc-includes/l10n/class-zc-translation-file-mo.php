<?php
/**
 * I18N: ZC_Translation_File_MO class.
 *
 * @package ZelocoreCMS
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class ZC_Translation_File_MO.
 *
 * @since 6.5.0
 */
class ZC_Translation_File_MO extends ZC_Translation_File {
	/**
	 * Endian value.
	 *
	...
	protected function detect_endian_and_validate_file( string $header ) {
		...
		// Force cast to an integer as it can be a float on x86 systems. See https://core.trac.zelocorecms.org/ticket/60678.
