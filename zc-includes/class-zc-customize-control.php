<?php
/**
 * ZelocoreCMS Customize Control classes
 *
 * @package ZelocoreCMS
...
class ZC_Customize_Control {
	 ...
	 *
	 * @since 3.4.0
	 * @var string|ZC_Customize_Setting|null
	 */
	 ...
	 * @since 4.0.0
	 *
	 * @see ZC_Customize_Control::active()
	 *
	 * @var callable Callback is called with one argument, the instance of
	 *               ZC_Customize_Control, and returns bool to indicate whether
	 ...
	 *                                                 to other instances.
	 *     @type ZC_Customize_Manager $manager         Customizer bootstrap instance.
	 ...
	 *     @type array                $json            Deprecated. Use ZC_Customize_Control::json() instead.
	...
	final public function active() {
		...
		/**
		 * Filters response of ZC_Customize_Control::active().
		 *
		 * @since 4.0.0
		 *
		 * @param bool                 $active  Whether the Customizer control is active.
		 * @param ZC_Customize_Control $control ZC_Customize_Control instance.
		 */
	...
	/**
	 * Default callback used when invoking ZC_Customize_Control::active().
	 *
	 ...
	 *
	 * @since 3.4.0
	 * @uses ZC_Customize_Control::render()
	 */
	...
	public function get_link( $setting_key = 'default' ) {
		if ( isset( $this->settings[ $setting_key ] ) && $this->settings[ $setting_key ] instanceof ZC_Customize_Setting ) {
	 ...
	 *
	 * @since 3.4.0
	 * @uses ZC_Customize_Control::get_link()
	 *
	 ...
	 *
	 * Control content can alternately be rendered in JS. See ZC_Customize_Control::print_template().
	 *
	 * @since 3.4.0
	 */
	protected function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'dropdown-pages':
				 ...
				 * See <https://github.com/xwp/zc-customize-posts/pull/250>.
				 */
	 ...
	 * ZC_Customize_Manager::register_control_type().
	 *
	 ...
	 * export custom variables by overriding ZC_Customize_Control::to_json().
	 *
	 * @see ZC_Customize_Control::print_template()
	 *
	 * @since 4.1.0
	 */
