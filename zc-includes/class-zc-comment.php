...
final class ZC_Comment {
	...
	/**
	 * Retrieves a ZC_Comment instance.
	 *
	 * @since 4.4.0
	 *
	...
	public static function get_instance( $id ) {
		...
		if ( ! $_comment ) {
			...
			zc_cache_add( $_comment->comment_ID, $_comment, 'comment' );
		}

		return new ZC_Comment( $_comment );
	}
	 ...
	 * }
	 * @return ZC_Comment[] Array of `ZC_Comment` objects.
	 */
	public function get_children( $args = array() ) {
		...
		$_args           = zc_parse_args( $args, $defaults );
	 ...
	 *
	 * Used by `ZC_Comment_Query` when bulk-filling descendants.
	 *
	 * @since 4.4.0
	 *
	 * @param ZC_Comment $child Child comment.
	 */
	public function add_child( ZC_Comment $child ) {
	 ...
	 * @return ZC_Comment|false Returns the comment object if found, otherwise false.
	 */
