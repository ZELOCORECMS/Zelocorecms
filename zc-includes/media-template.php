 ...
 * @since 3.9.0
 */
function zc_underscore_audio_template() {
	$audio_types = zc_get_audio_extensions();
	?>
 ...
 * @since 3.9.0
 */
function zc_underscore_video_template() {
...
#>
<div style="{{ w_rule }}" class="zc-video">
<video controls
	class="zc-video-shortcode {{ classes.join( ' ' ) }}"
	<# if ( w ) { #>width="{{ w }}"<# } #>
	<# if ( h ) { #>height="{{ h }}"<# } #>
	<?php
	$props = array(
 ...
 * @since 3.5.0
 */
function zc_print_media_templates() {
	$class = 'media-modal zc-core-ui';
	...
	<script type="text/html" id="tmpl-media-modal">
		<div id="zc-media-modal" tabindex="0" class="<?php echo $class; ?>" role="dialog" aria-labelledby="media-frame-title">
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php elseif ( is_multisite() && ! is_upload_space_available() ) : ?>
			<div class="upload-ui">
				...
				<?php
				/** This action is documented in zc-admin/includes/media.php */
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			...
			if ( isset( $_GET['error'] ) && 'deprecated' === $_GET['error'] ) {
				zc_admin_notice(
					__( 'The Edit Media screen is deprecated as of ZelocoreCMS 6.3. Please use the Media Library instead.' ),
					array(
						'id'                 => 'message',
			...
			<div class="thumbnail thumbnail-{{ data.type }}">
				...
				<# if ( 'audio' === data.type ) { #>
				<div class="zc-media-wrapper zc-audio">
					<audio style="visibility: hidden" controls class="zc-audio-shortcode" width="100%" preload="none">
				...
				<div style="{{ w_rule }}" class="zc-media-wrapper zc-video">
					<video controls="controls" class="zc-video-shortcode" preload="metadata"
		...
		<div class="attachment-info">
			...
			<div class="actions">
				<# if ( data.link ) { #>
					<?php
					$view_media_text = ( '1' === get_option( 'zc_attachment_pages_enabled' ) ) ? __( 'View attachment page' ) : __( 'View media file' );
					?>
			...
			<div class="embed-media-settings">
				<div class="column-settings">
					...
					<# if ( data.attachment ) { #>
						...
						<# } #>
							<div class="custom-size zc-clearfix<# if ( data.model.size !== 'custom' ) { #> hidden<# } #>">
	...
	<script type="text/html" id="tmpl-audio-details">
		...
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-audio-settings">
				<?php zc_underscore_audio_template(); ?>
	...
	<script type="text/html" id="tmpl-video-details">
		...
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-video-settings">
				...
				<?php zc_underscore_video_template(); ?>
				...
				<# _.each( data.attachments, function( attachment, index ) { #>
					<dl class="gallery-item">
						...
						<# if ( attachment.caption ) { #>
							<dd class="zc-caption-text gallery-caption">
