<?php
/**
 * WP AI Client: ZC_AI_Client_Ability_Function_Resolver class
 *
 * @package ZelocoreCMS
 * @subpackage AI
 * @since 7.0.0
...
/**
 * Resolves and executes ZelocoreCMS Abilities API function calls from AI models.
 *
 ...
 * @since 7.0.0
 */
class ZC_AI_Client_Ability_Function_Resolver {
	 ...
	 * @since 7.0.0
	 *
	 * @param ZC_Ability|string ...$abilities The abilities that this resolver is allowed to execute.
	 */
	...
	/**
	 * Executes a ZelocoreCMS ability from a function call.
	 *
	...
	public function execute_ability( FunctionCall $call ): FunctionResponse {
		...
		$ability = zc_get_ability( $ability_name );
