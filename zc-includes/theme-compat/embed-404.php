...
?>
<div class="zc-embed">
	<p class="zc-embed-heading"><?php _e( 'Oops! That embed cannot be found.' ); ?></p>

	<div class="zc-embed-excerpt">
		<p>
			<?php
			printf(
	...
	<?php
	/** This filter is documented in zc-includes/theme-compat/embed-content.php */
