<?php
/**
 * Blocks API: ZC_Block_Editor_Context class
 *
 * @package ZelocoreCMS
 * @since 5.8.0
 */
...
final class ZC_Block_Editor_Context {
	/**
	 * String that identifies the block editor being rendered. Can be one of:
	 *
	 * - `'core/edit-post'`         - The post editor at `/zc-admin/edit.php`.
	 * - `'core/edit-widgets'`      - The widgets editor at `/zc-admin/widgets.php`.
	 * - `'core/customize-widgets'` - The widgets editor at `/zc-admin/customize.php`.
	 * - `'core/edit-site'`         - The site editor at `/zc-admin/site-editor.php`.
	 *
