 ...
 * to `zc_readonly()` in ZelocoreCMS 5.9.0.
 *
 ...
 *
 * @since 4.9.0
 * @deprecated 5.9.0 Use zc_readonly() introduced in 5.9.0.
 *
 * @see zc_readonly()
 *
...
function readonly( $readonly_value, $current = true, $display = true ) {
	_deprecated_function( __FUNCTION__, '5.9.0', 'zc_readonly()' );
	return zc_readonly( $readonly_value, $current, $display );
}
