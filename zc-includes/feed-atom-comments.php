...
<feed
	...
	<?php
		/** This action is documented in zc-includes/feed-atom.php */
		do_action( 'atom_ns' );
...
>
	...
	if ( is_singular() ) {
		...
		printf( ent2ncr( __( 'Comments for %s' ) ), get_zc_title_rss() );
	}
	?>
	</title>
...
while ( have_comments() ) :
	...
	<entry>
		...
		if ( ! is_singular() ) {
			...
			/** This filter is documented in zc-includes/feed.php */
