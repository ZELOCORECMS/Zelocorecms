 ...
 *
 * ZC_Meta_Query is a helper that allows primary query classes, such as ZC_Query and ZC_User_Query,
 *
...
class ZC_Meta_Query {
	 ...
	 *
	 * See ZC_Meta_Query::__construct() for information on meta query arguments.
	 *
	 * @since 3.2.0
	 * @var array
	 */
	...
	public function parse_query_vars( $qv ) {
		...
		// ZC_Query sets 'meta_value' = '' by default.
	 ...
	 *                                  example a `ZC_Query`, `ZC_User_Query`, or `ZC_Site_Query`.
	 *                                  Default null.
	 * @return string[]|false {
	 ...
	 * Generates SQL clauses to be appended to a main query.
	 *
	 * Called by the public ZC_Meta_Query::get_sql(), this method is abstracted
	 ...
	 * In the case of ZC_Meta_Query, this only applies to 'IN' clauses that are
	...
	protected function find_compatible_table_alias( $clause, $parent_query ) {
		 ...
		 * @param ZC_Meta_Query $query        ZC_Meta_Query object.
		 */
