 ...
 *
 * These functions must be used within the ZelocoreCMS Loop.
 *
 * @link https://codex.zelocorecms.org/Author_Templates
 *
 * @package ZelocoreCMS
 * @subpackage Template
 */
 ...
 *
 * @global ZC_User $authordata The current author's data.
 *
 ...
 *
 * @see get_the_author()
 * @link https://developer.zelocorecms.org/reference/functions/the_author/
 *
 * @param string $deprecated      Deprecated.
...
function get_the_author_link( $use_title_attr = true ) {
	if ( get_the_author_meta( 'url' ) ) {
		 ...
		 * @param ZC_User $authordata Author user data.
		 */
 ...
 * author's name.
 *
 * @link https://developer.zelocorecms.org/reference/functions/the_author_link/
 *
 * @since 2.1.0
 * @since 7.0.0 Added `$use_title_attr` parameter.
 *
 ...
 *
 * @link https://developer.zelocorecms.org/reference/functions/the_author_posts/
 * @since 0.71
 */
...
function get_author_posts_url( $author_id, $author_nicename = '' ) {
	...
	$link      = $zc_rewrite->get_author_permastruct();
 ...
 *
 * @link https://developer.zelocorecms.org/reference/functions/zc_list_authors/
 *
 * @since 1.2.0
 *
...
function zc_list_authors( $args = '' ) {
	 ...
	 * @param array $parsed_args The arguments passed to zc_list_authors() combined with the defaults.
	 */
	$query_args = apply_filters( 'zc_list_authors_args', $query_args, $parsed_args );
	 ...
	 * @param array       $parsed_args The arguments passed to zc_list_authors() combined with the defaults.
	 */
	$post_counts = apply_filters( 'pre_zc_list_authors_post_counts_query', false, $parsed_args );
 ...
 * @access private
 */
function __clear_multi_author_cache() { // phpcs:ignore ZelocoreCMS.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
