<?php
/**
 * Widget API: ZC_Nav_Menu_Widget class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see ZC_Widget
 */
class ZC_Nav_Menu_Widget extends ZC_Widget {
	...
	public function widget( $args, $instance ) {
		// Get menu.
		$nav_menu = ! empty( $instance['nav_menu'] ) ? zc_get_nav_menu_object( $instance['nav_menu'] ) : false;
		 ...
		 *     An array of arguments passed to zc_nav_menu() to retrieve a navigation menu.
		 *
		 *     @type callable|bool $fallback_cb Callback to fire if the menu doesn't exist. Default empty.
		 *     @type mixed         $menu        Menu ID, slug, or name.
		 * }
		 * @param ZC_Term $nav_menu      Nav menu object for the current menu.
		 * @param array   $args          Display arguments for the current widget.
		 * @param array   $instance      Array of settings for the current widget.
		 */
		zc_nav_menu( apply_filters( 'widget_nav_menu_args', $nav_menu_args, $nav_menu, $args, $instance ) );
	...
	public function form( $instance ) {
		...
		<div class="nav-menu-widget-form-controls" <?php echo $empty_menus_style; ?>>
			...
			<?php if ( $zc_customize instanceof ZC_Customize_Manager ) : ?>
