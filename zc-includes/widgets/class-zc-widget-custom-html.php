<?php
/**
 * Widget API: ZC_Widget_Custom_HTML class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.8.1
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Custom_HTML extends ZC_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'ZC_Widget_Custom_HTML', 'render_control_template_scripts' ) );

		// Note this action is used to ensure the help text is added to the end.
		add_action( 'admin_head-widgets.php', array( 'ZC_Widget_Custom_HTML', 'add_help_text' ) );
	}
	...
	public function widget( $args, $instance ) {
		...
		/** This filter is documented in zc-includes/widgets/class-zc-widget-text.php */
		 ...
		 * @param ZC_Widget_Custom_HTML $widget   Current Custom HTML widget instance.
		 */
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['content'] = zc_kses_post( $new_instance['content'] );
		}
		return $instance;
	}
	...
	public function enqueue_admin_scripts() {
		$settings = zc_enqueue_code_editor(
			array(
				'type'       => 'text/html',
				'codemirror' => array(
					'indentUnit' => 2,
	 ...
	 *
	 * @since 4.8.1
	 * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `ZC_Widget_Custom_HTML::render_control_template_scripts()`.
	 *
	 * @see ZC_Widget_Custom_HTML::render_control_template_scripts()
	 *
	 * @param array $instance Current instance.
	 */
	public function form( $instance ) {
		$instance = zc_parse_args( (array) $instance, $this->default_instance );
		?>
