<?php
/**
 * Widget API: ZC_Widget_Archives class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Archives extends ZC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" name="archive-dropdown">
			...
			<?php zc_get_archives( $dropdown_args ); ?>
...
( ( dropdownId ) => {
	 ...
	 *                            ZC_Widget_Archives::form().
	 * @param array $old_instance Old settings for this instance.
	 * @return array Updated settings to save.
	 */
	public function update( $new_instance, $old_instance ) {
		$instance             = $old_instance;
		$new_instance         = zc_parse_args(
			(array) $new_instance,
			array(
				'title'    => '',
				'count'    => 0,
