<?php
/**
 * Widget API: ZC_Widget_Media_Audio class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.8.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Media_Audio extends ZC_Widget_Media {
	...
	public function get_instance_schema() {
		...
		foreach ( zc_get_audio_extensions() as $audio_extension ) {
	...
	public function enqueue_preview_scripts() {
		...
		if ( 'mediaelement' === apply_filters( 'zc_audio_shortcode_library', 'mediaelement' ) ) {
	...
	public function render_control_template_scripts() {
		...
		?>
		<script type="text/html" id="tmpl-zc-media-widget-audio-preview">
