<?php
/**
 * Widget API: ZC_Widget_Recent_Comments class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Recent_Comments extends ZC_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'zc_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see ZC_Comment_Query::query() for information on accepted arguments.
			 *
