<?php
/**
 * Widget API: ZC_Widget_Text class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Text extends ZC_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'ZC_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `ZC_Widget_Custom_HTML` object in addition to a `ZC_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param ZC_Widget_Text|ZC_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param ZC_Widget_Text $widget   Current Text widget instance.
			 */
	 ...
	 * @since 4.9.0
	 *
	 * @see ZC_Widget_Media_Video::inject_video_max_width_style()
	 *
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['text'] = zc_kses_post( $new_instance['text'] );
		}
	...
	public function enqueue_preview_scripts() {
		...
		zc_playlist_scripts( 'audio' );
		zc_playlist_scripts( 'video' );
	}
	 ...
	 *
	 * @see ZC_Widget_Text::render_control_template_scripts()
	...
	public static function render_control_template_scripts() {
		...
		<script type="text/html" id="tmpl-widget-text-control-fields">
			...
			<?php if ( ! in_array( 'text_widget_custom_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="zc-pointer custom-html-widget-pointer zc-pointer-top">
					<div class="zc-pointer-content">
						...
						<?php endif; ?>
						<div class="zc-pointer-buttons">
							<a class="close" href="#"><?php _e( 'Dismiss' ); ?></a>
						</div>
					</div>
					<div class="zc-pointer-arrow">
						<div class="zc-pointer-arrow-inner"></div>
					</div>
				</div>
			<?php endif; ?>

			<?php if ( ! in_array( 'text_widget_paste_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="zc-pointer paste-html-pointer zc-pointer-top">
					<div class="zc-pointer-content">
			...
			<p>
				...
				<textarea id="{{ elementIdPrefix }}text" class="widefat text zc-editor-area" style="height: 200px" rows="16" cols="20"></textarea>
			</p>
		</script>
		<?php
	}
