<?php
/**
 * Widget API: ZC_Widget_Block class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 5.8.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_Block extends ZC_Widget {
	...
	public function widget( $args, $instance ) {
		$instance = zc_parse_args( $instance, $this->default_instance );
		 ...
		 * @param ZC_Widget_Block $widget   Current Block widget instance.
		 */
		echo apply_filters(
