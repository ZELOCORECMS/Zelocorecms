<?php
/**
 * Widget API: ZC_Widget_RSS class
 *
 * @package ZelocoreCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see ZC_Widget
 */
class ZC_Widget_RSS extends ZC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			$feed_link = sprintf(
				...
				esc_url( $feed_icon ),
				esc_attr__( 'RSS' ),
				( zc_lazy_loading_enabled( 'img', 'rss_widget_feed_icon' ) ? ' loading="lazy"' : '' )
			);
		...
		zc_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return zc_widget_rss_process( $new_instance, $testurl );
	}
