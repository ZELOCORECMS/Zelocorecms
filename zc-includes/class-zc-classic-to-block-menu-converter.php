<?php
/**
 * ZC_Classic_To_Block_Menu_Converter class
 *
 * @package ZelocoreCMS
 * @since 6.3.0
 */
 ...
 * @since 6.3.0
 */
class ZC_Classic_To_Block_Menu_Converter {
	 ...
	 * @since 6.3.0
	 *
	 * @param ZC_Term $menu The Menu term object of the menu to convert.
	 * @return string|ZC_Error The serialized and normalized parsed blocks on success,
	 *                         an empty string when there are no menus to convert,
	 *                         or ZC_Error on invalid menu.
	 */
