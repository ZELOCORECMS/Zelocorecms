<?php
/**
 * Connectors API: ZC_Connector_Registry class.
 *
 * @package ZelocoreCMS
 ...
 *
 *  - `zc_is_connector_registered()` — check if a connector exists.
 *  - `zc_get_connector()`           — retrieve a single connector's data.
 *  - `zc_get_connectors()`          — retrieve all registered connectors.
 *
 * Plugins receive the registry instance via the `zc_connectors_init` action
 * to register or override connectors directly.
 *
 * @since 7.0.0
 * @access private
 *
 * @see zc_is_connector_registered()
 * @see zc_get_connector()
 * @see zc_get_connectors()
 * @see _zc_connectors_init()
 *
 ...
 * }
 */
final class ZC_Connector_Registry {
	/**
	 * The singleton instance of the registry.
	 *
	 * @since 7.0.0
	 */
	private static ?ZC_Connector_Registry $instance = null;
	 ...
	 * @since 7.0.0
	 *
	 * @see ZC_Connector_Registry::unregister()
	 *
	...
	public function register( string $id, array $args ): ?array {
		...
		if ( 'ai_provider' === $args['type'] && ! zc_supports_ai() ) {
	 ...
	 * @since 7.0.0
	 *
	 * @see ZC_Connector_Registry::register()
	 ...
	 *
	 * Do not use this method directly. Instead, use the `zc_get_connectors()` function.
	 *
	 * @since 7.0.0
	 *
	 * @see zc_get_connectors()
	 ...
	 *
	 * Do not use this method directly. Instead, use the `zc_is_connector_registered()` function.
	 *
	 * @since 7.0.0
	 *
	 * @see zc_is_connector_registered()
	 ...
	 *
	 * Do not use this method directly. Instead, use the `zc_get_connector()` function.
	 *
	 * Triggers a `_doing_it_wrong()` notice if the connector is not registered.
	 * Use `is_registered()` to check first when the connector may not exist.
	 *
	 ...
	 * @since 7.0.0
	 *
	 * @return ZC_Connector_Registry|null The main registry instance, or null if not yet initialized.
	 */
	 ...
	 *
	 * Called by `_zc_connectors_init()` during the `init` action. Must not be
	 ...
	 * @see _zc_connectors_init()
	 *
	 * @param ZC_Connector_Registry $registry The registry instance.
	 */
	public static function set_instance( ZC_Connector_Registry $registry ): void {
