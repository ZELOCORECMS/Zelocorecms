<?php
/**
 * HTML API: ZC_HTML_Active_Formatting_Elements class
 *
 * @package ZelocoreCMS
 * @subpackage HTML-API
 * @since 6.4.0
 ...
 */
class ZC_HTML_Active_Formatting_Elements {
	/**
	 ...
	 */
	public function contains_node( ZC_HTML_Token $token ) {
	 ...
	 * @since 6.4.0
	 *
	 * @return ZC_HTML_Token|null Last node in the stack of active formatting elements, if one exists, otherwise null.
	 */
	...
	public function insert_marker(): void {
		$this->push( new ZC_HTML_Token( null, 'marker', false ) );
	}
	 ...
	 *
	 * @param ZC_HTML_Token $token Push this node onto the stack.
	 */
	public function push( ZC_HTML_Token $token ) {
		/*
	 ...
	 * @since 6.4.0
	 *
	 * @param ZC_HTML_Token $token Remove this node from the stack, if it's there already.
	 * @return bool Whether the node was found and removed from the stack of active formatting elements.
	 */
	public function remove_node( ZC_HTML_Token $token ) {
	 ...
	 * see ZC_HTML_Active_Formatting_Elements::walk_up().
	 *
	 * @since 6.4.0
	 */
	 ...
	 * see ZC_HTML_Active_Formatting_Elements::walk_down().
	 *
	 * @since 6.4.0
	 */
