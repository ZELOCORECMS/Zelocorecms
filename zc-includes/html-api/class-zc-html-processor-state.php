<?php
/**
 * HTML API: ZC_HTML_Processor_State class
 *
 * @package ZelocoreCMS
 * @subpackage HTML-API
 * @since 6.4.0
...
class ZC_HTML_Processor_State {
	 ...
	 * @see ZC_HTML_Processor_State::$insertion_mode
	 *
	 * @var string
	 */
	 ...
	 *
	 * @var ZC_HTML_Active_Formatting_Elements
	 */
	 ...
	 *
	 * @since 6.4.0
	 * @deprecated 6.8.0 ZC_HTML_Processor tracks the context_node internally.
	 *
	 * @var null
	 */
	...
	public function __construct() {
		$this->stack_of_open_elements     = new ZC_HTML_Open_Elements();
		$this->active_formatting_elements = new ZC_HTML_Active_Formatting_Elements();
	}
}
