<?php
/**
 * HTML API: ZC_HTML_Stack_Event class
 *
 * @package ZelocoreCMS
 * @subpackage HTML-API
 * @since 6.6.0
 ...
 *
 * This class is for internal usage of the ZC_HTML_Processor class.
 *
 * @access private
 * @ignore
 *
...
class ZC_HTML_Stack_Event {
	 ...
	 * @since 6.6.0
	 *
	 * @param ZC_HTML_Token $token      Token associated with stack event, always an opening token.
	 * @param string        $operation  One of self::PUSH or self::POP.
	 * @param string        $provenance "virtual" or "real".
	 */
	public function __construct( ZC_HTML_Token $token, string $operation, string $provenance ) {
		$this->token      = $token;
