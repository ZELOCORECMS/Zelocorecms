<?php
/**
 * Customize API: ZC_Widget_Form_Customize_Control class
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Widget_Form_Customize_Control extends ZC_Customize_Control {
	/**
	...
	public function to_json() {
		...
		$widget = $zc_registered_widgets[ $this->widget_id ];
		...
		$args                 = zc_list_widget_controls_dynamic_sidebar(
			array(
				0 => $args,
				1 => $widget['params'][0],
			)
