<?php
/**
 * Customize API: ZC_Customize_Media_Control class
 *
 * @package ZelocoreCMS
 ...
 * @since 4.2.0
 *
 * @see ZC_Customize_Control
 */
class ZC_Customize_Media_Control extends ZC_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @since 4.1.0
	 * @since 4.2.0 Moved from ZC_Customize_Upload_Control.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = zc_parse_args( $this->button_labels, $this->get_default_button_labels() );
	}
	 ...
	 * @since 4.2.0 Moved from ZC_Customize_Upload_Control.
	 *
	 * @see ZC_Customize_Control::to_json()
	 */
	public function to_json() {
		...
		if ( is_object( $this->setting ) ) {
			if ( $this->setting->default ) {
				 ...
				 */
				$ext       = zc_check_filetype( $this->setting->default )['ext'];
				...
				$default_attachment = array(
					...
					'type'  => $type,
					'icon'  => zc_mime_type_icon( $type, '.svg' ),
					'title' => zc_basename( $this->setting->default ),
				);
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = zc_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 4.2.0 Moved from ZC_Customize_Upload_Control.
	 *
	 * @see ZC_Customize_Media_Control::content_template()
	 */
			...
			<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
				<div class="thumbnail thumbnail-{{ data.attachment.type }}">
					...
					<# } else if ( 'video' === data.attachment.type ) { #>
						<div class="zc-media-wrapper zc-video">
