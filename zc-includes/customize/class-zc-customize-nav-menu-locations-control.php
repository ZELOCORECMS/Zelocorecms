<?php
/**
 * Customize API: ZC_Customize_Nav_Menu_Locations_Control class
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Customize_Nav_Menu_Locations_Control extends ZC_Customize_Control {
					...
					<# if ( data.isCreating ) { #>
						<p>
							...
							printf(
								...
								__( 'https://zelocorecms.org/documentation/article/manage-zelocorecms-widgets/' ),
