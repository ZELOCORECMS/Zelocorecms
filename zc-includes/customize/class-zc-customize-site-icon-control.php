<?php
/**
 * Customize API: ZC_Customize_Site_Icon_Control class
 *
 * @package ZelocoreCMS
 ...
 * @since 4.3.0
 *
 * @see ZC_Customize_Cropped_Image_Control
 */
class ZC_Customize_Site_Icon_Control extends ZC_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		add_action( 'customize_controls_print_styles', 'zc_site_icon', 99 );
	}
