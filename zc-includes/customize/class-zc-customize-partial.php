<?php
/**
 * Customize API: ZC_Customize_Partial class
 *
 * @package ZelocoreCMS
 ...
 * This class is analogous of ZC_Customize_Control.
 *
 * @since 4.5.0
 */
...
class ZC_Customize_Partial {
	 ...
	 * @since 4.5.0
	 *
	 * @see ZC_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *               ZC_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param ZC_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 *                                           Callback is called with one argument, the instance of ZC_Customize_Partial.
	 ...
	 * }
	 */
	public function __construct( ZC_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param ZC_Customize_Partial $partial           ZC_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking ZC_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( ZC_Customize_Partial $partial, $context = array() ) {
