<?php
/**
 * Customize API: ZC_Customize_Custom_CSS_Setting class
 *
 ...
 */
final class ZC_Customize_Custom_CSS_Setting extends ZC_Customize_Setting {
	...
	/**
	 * ZC_Customize_Custom_CSS_Setting constructor.
	 *
	 * @since 4.7.0
	 *
	...
	public function preview() {
		...
		add_filter( 'zc_get_custom_css', array( $this, 'filter_previewed_zc_get_custom_css' ), 9, 2 );
		return true;
	}

	/**
	 * Filters `zc_get_custom_css` for applying the customized value.
	 *
	 * This is used in the preview when `zc_get_custom_css()` is called for rendering the styles.
	 *
	 * @since 4.7.0
	 *
	 * @see zc_get_custom_css()
	 *
	 * @param string $css        Original CSS.
	 * @param string $stylesheet Current stylesheet.
	 * @return string CSS.
	 */
	public function filter_previewed_zc_get_custom_css( $css, $stylesheet ) {
	 ...
	 * @since 4.7.0
	 *
	 * @see ZC_Customize_Setting::value()
	 *
	 * @return string
	 */
	public function value() {
		...
		$value   = '';
		$post    = zc_get_custom_css_post( $this->stylesheet );
		if ( $post ) {
	 ...
	 *
	 * @see ZC_REST_Global_Styles_Controller::validate_custom_css()
	 *
