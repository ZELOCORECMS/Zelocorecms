<?php
/**
 * Customize API: ZC_Customize_Header_Image_Control class
 *
 * @package ZelocoreCMS
 ...
 * @since 3.4.0
 *
 * @see ZC_Customize_Image_Control
 */
class ZC_Customize_Header_Image_Control extends ZC_Customize_Image_Control {
	...
	public function enqueue() {
		zc_enqueue_media();
		zc_enqueue_script( 'customize-views' );
		...
		zc_localize_script(
			...
			array(
				...
				'nonces'   => array(
					'add'    => zc_create_nonce( 'header-add' ),
					'remove' => zc_create_nonce( 'header-remove' ),
				),
