<?php
/**
 * Customize API: ZC_Customize_Nav_Menu_Item_Control class
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Customize_Nav_Menu_Item_Control extends ZC_Customize_Control {
	 ...
	 *
	 * @since 4.3.0
	 * @var ZC_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
	...
	public function content_template() {
		...
		<# } #>
			 ...
			 * @since 5.4.0
			 */
			do_action( 'zc_nav_menu_item_custom_fields_customize_template' );
			?>
