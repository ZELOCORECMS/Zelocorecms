<?php
/**
 * Customize API: ZC_Customize_Date_Time_Control class
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Customize_Date_Time_Control extends ZC_Customize_Control {
	...
	public function content_template() {
		...
		<# _.defaults( data, <?php echo zc_json_encode( $data ); ?> ); #>
	...
	public function get_month_choices() {
		...
		$months = array();
		for ( $i = 1; $i < 13; $i++ ) {
			$month_text = $zc_locale->get_month_abbrev( $zc_locale->get_month( $i ) );
