<?php
/**
 * Customize API: ZC_Customize_Code_Editor_Control class
 *
 * @package ZelocoreCMS
 ...
 */
class ZC_Customize_Code_Editor_Control extends ZC_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = zc_enqueue_code_editor(
			array_merge(
				array(
					'type'       => $this->code_type,
					'codemirror' => array(
