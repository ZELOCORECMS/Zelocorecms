<?php
/**
 * ZelocoreCMS implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 ...
 */
function _zc_can_use_pcre_u( $set = null ) {
...
function _mb_substr( $str, $start, $length = null, $encoding = null ) {
	 ...
	 */
	$starting_byte_offset = _zc_utf8_codepoint_span( $str, 0, $normalized_start );
	...
	$byte_length = isset( $normalized_length )
		? _zc_utf8_codepoint_span( $str, $starting_byte_offset, $normalized_length )
...
if ( ! function_exists( 'utf8_encode' ) ) :
	if ( extension_loaded( 'mbstring' ) ) :
		...
		function utf8_encode( $iso_8859_1_text ): string {
			...
			return _zc_utf8_encode_fallback( $iso_8859_1_text );
		}
...
if ( ! function_exists( 'utf8_decode' ) ) :
	if ( extension_loaded( 'mbstring' ) ) :
		...
		function utf8_decode( $utf8_text ): string {
			...
			return _zc_utf8_decode_fallback( $utf8_text );
		}
