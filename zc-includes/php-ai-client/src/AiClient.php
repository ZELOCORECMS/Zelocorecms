...
namespace ZelocoreCMS\AiClient;
...
use ZelocoreCMS\AiClient\Providers\Contracts\ProviderAvailabilityInterface;
 ...
 * - Traditional API for array-based configuration (ZelocoreCMS style)
