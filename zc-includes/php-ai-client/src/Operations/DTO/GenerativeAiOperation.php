...
namespace ZelocoreCMS\AiClient\Operations\DTO;

use ZelocoreCMS\AiClient\Common\AbstractDataTransferObject;
use ZelocoreCMS\AiClient\Operations\Contracts\OperationInterface;
use ZelocoreCMS\AiClient\Operations\Enums\OperationStateEnum;
