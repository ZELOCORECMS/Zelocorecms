...
namespace ZelocoreCMS\AiClient\Providers\Http;

use ZelocoreCMS\AiClientDependencies\Http\Discovery\Psr17FactoryDiscovery;
use ZelocoreCMS\AiClientDependencies\Http\Discovery\Psr18ClientDiscovery;
...
class HttpTransporter implements HttpTransporterInterface
{
    ...
    public function send(Request $request, ?RequestOptions $options = null): Response
    {
        ...
        } catch (\ZelocoreCMS\AiClientDependencies\Psr\Http\Client\NetworkExceptionInterface $e) {
            throw NetworkException::fromPsr18NetworkException($psr7Request, $e);
        } catch (\ZelocoreCMS\AiClientDependencies\Psr\Http\Client\ClientExceptionInterface $e) {
