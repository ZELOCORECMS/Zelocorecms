...
namespace ZelocoreCMS\AiClient\Providers\Http\Enums;

use ZelocoreCMS\AiClient\Common\AbstractEnum;
use ZelocoreCMS\AiClient\Common\Contracts\WithArrayTransformationInterface;
