...
namespace ZelocoreCMS\AiClient\Providers\Http\DTO;
...
use ZelocoreCMS\AiClient\Providers\Http\Collections\HeadersCollection;
use ZelocoreCMS\AiClient\Providers\Http\Enums\HttpMethodEnum;
/**
...
class Request extends AbstractDataTransferObject
{
     ...
     */
    protected ?\ZelocoreCMS\AiClient\Providers\Http\DTO\RequestOptions $options = null;
    /**
     * Constructor.
     *
     * @since 0.1.0
     ...
     */
    public function __construct(HttpMethodEnum $method, string $uri, array $headers = [], $data = null, ?\ZelocoreCMS\AiClient\Providers\Http\DTO\RequestOptions $options = null)
    {
        if (empty($uri)) {
     ...
     */
    public function getOptions(): ?\ZelocoreCMS\AiClient\Providers\Http\DTO\RequestOptions
    {
        return $this->options;
    }
    /**
     ...
     */
    public function withOptions(?\ZelocoreCMS\AiClient\Providers\Http\DTO\RequestOptions $options): self
    {
        $new = clone $this;
        $new->options = $options;
        return $new;
    ...
    public static function fromArray(array $array): self
    {
        ...
        return new self(HttpMethodEnum::from($array[self::KEY_METHOD]), $array[self::KEY_URI], $array[self::KEY_HEADERS] ?? [], $array[self::KEY_BODY] ?? null, isset($array[self::KEY_OPTIONS]) ? \ZelocoreCMS\AiClient\Providers\Http\DTO\RequestOptions::fromArray($array[self::KEY_OPTIONS]) : null);
    }
    /**
