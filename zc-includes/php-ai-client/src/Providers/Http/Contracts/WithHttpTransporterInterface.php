...
interface WithHttpTransporterInterface
{
     ...
     * @return void
     */
    public function setHttpTransporter(\ZelocoreCMS\AiClient\Providers\Http\Contracts\HttpTransporterInterface $transporter): void;
    /**
     ...
     */
    public function getHttpTransporter(): \ZelocoreCMS\AiClient\Providers\Http\Contracts\HttpTransporterInterface;
}
