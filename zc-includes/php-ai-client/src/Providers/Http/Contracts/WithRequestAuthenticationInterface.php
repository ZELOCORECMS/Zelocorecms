...
namespace ZelocoreCMS\AiClient\Providers\Http\Contracts;
...
interface WithRequestAuthenticationInterface
{
     ...
     * @return void
     */
    public function setRequestAuthentication(\ZelocoreCMS\AiClient\Providers\Http\Contracts\RequestAuthenticationInterface $authentication): void;
    /**
     ...
     */
    public function getRequestAuthentication(): \ZelocoreCMS\AiClient\Providers\Http\Contracts\RequestAuthenticationInterface;
}
