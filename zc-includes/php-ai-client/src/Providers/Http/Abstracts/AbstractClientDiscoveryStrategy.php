...
namespace ZelocoreCMS\AiClient\Providers\Http\Abstracts;

use ZelocoreCMS\AiClientDependencies\Http\Discovery\Psr18ClientDiscovery;
use ZelocoreCMS\AiClientDependencies\Http\Discovery\Strategy\DiscoveryStrategy;
...
abstract class AbstractClientDiscoveryStrategy implements DiscoveryStrategy
{
    ...
    {
        if (!class_exists('ZelocoreCMS\AiClientDependencies\Http\Discovery\Psr18ClientDiscovery')) {
            return;
        }
    ...
    public static function getCandidates($type)
    {
        ...
        $psr17Factories = ['ZelocoreCMS\AiClientDependencies\Psr\Http\Message\RequestFactoryInterface', 'ZelocoreCMS\AiClientDependencies\Psr\Http\Message\ResponseFactoryInterface', 'ZelocoreCMS\AiClientDependencies\Psr\Http\Message\ServerRequestFactoryInterface', 'ZelocoreCMS\AiClientDependencies\Psr\Http\Message\StreamFactoryInterface', 'ZelocoreCMS\AiClientDependencies\Psr\Http\Message\UploadedFileFactoryInterface', 'ZelocoreCMS\AiClientDependencies\Psr\Http\Message\UriFactoryInterface'];
