...
namespace ZelocoreCMS\AiClient\Providers\DTO;
...
class ProviderModelsMetadata extends AbstractDataTransferObject
{
     ...
     */
    protected \ZelocoreCMS\AiClient\Providers\DTO\ProviderMetadata $provider;
    /**
     ...
     */
    public function __construct(\ZelocoreCMS\AiClient\Providers\DTO\ProviderMetadata $provider, array $models)
    {
     ...
     */
    public function getProvider(): \ZelocoreCMS\AiClient\Providers\DTO\ProviderMetadata
    {
    ...
    {
        return ['type' => 'object', 'properties' => [self::KEY_PROVIDER => \ZelocoreCMS\AiClient\Providers\DTO\ProviderMetadata::getJsonSchema(), self::KEY_MODELS => ['type' => 'array', 'items' => ModelMetadata::getJsonSchema(), 'description' => 'The available models for this provider.']], 'required' => [self::KEY_PROVIDER, self::KEY_MODELS]];
    }
    /**
     * {@inheritDoc}
     *
    ...
    public static function fromArray(array $array): self
    {
        ...
        return new self(\ZelocoreCMS\AiClient\Providers\DTO\ProviderMetadata::fromArray($array[self::KEY_PROVIDER]), array_map(static fn(array $modelData): ModelMetadata => ModelMetadata::fromArray($modelData), $array[self::KEY_MODELS]));
    }
}
