...
namespace ZelocoreCMS\AiClient\Providers\OpenAiCompatibleImplementation;
...
use ZelocoreCMS\AiClient\Messages\Enums\MessagePartChannelEnum;
use ZelocoreCMS\AiClient\Messages\Enums\MessageRoleEnum;
use ZelocoreCMS\AiClient\Messages\Enums\ModalityEnum;
use ZelocoreCMS\AiClient\Providers\ApiBasedImplementation\AbstractApiBasedModel;
use ZelocoreCMS\AiClient\Providers\Http\DTO\Request;
use ZelocoreCMS\AiClient\Providers\Http\DTO\Response;
use ZelocoreCMS\AiClient\Providers\Http\Enums\HttpMethodEnum;
use ZelocoreCMS\AiClient\Providers\Http\Exception\ResponseException;
use ZelocoreCMS\AiClient\Providers\Http\Util\ResponseUtil;
use ZelocoreCMS\AiClient\Providers\Models\TextGeneration\Contracts\TextGenerationModelInterface;
use ZelocoreCMS\AiClient\Results\DTO\Candidate;
use ZelocoreCMS\AiClient\Results\DTO\GenerativeAiResult;
use ZelocoreCMS\AiClient\Results\DTO\TokenUsage;
use ZelocoreCMS\AiClient\Results\Enums\FinishReasonEnum;
use ZelocoreCMS\AiClient\Tools\DTO\FunctionCall;
