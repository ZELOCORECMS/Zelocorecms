...
function _block_bindings_term_data_get_value( array $source_args, $block_instance ) {
	 ...
	 * Required for ZelocoreCMS 6.9+ navigation blocks. DO NOT REMOVE.
	 */
	...
	switch ( $source_args['field'] ) {
		...
		case 'link':
			...
			return is_zc_error( $term_link ) ? null : esc_url( $term_link );

		case 'slug':
			return esc_html( $term->slug );

		case 'description':
			return zc_kses_post( $term->description );
