 ...
 *
 * This class is most useful in ZelocoreCMS multi-network installations where the
...
class ZC_Network {
	...
	public static function get_instance( $network_id ) {
		...
		if ( false === $_network ) {
			...
			zc_cache_add( $network_id, $_network, 'networks' );
		}
		...
		return new ZC_Network( $_network );
	}

	/**
	 * Creates a new ZC_Network object.
	 *
	 ...
	 * @since 4.4.0
	 *
	 * @param ZC_Network|object $network A network object.
	 */
	...
	private function get_main_site_id() {
		 ...
		 * @param ZC_Network $network      The network object for which the main site was detected.
		 */
	...
	public static function get_by_path( $domain = '', $path = '', $segments = null ) {
		 ...
		 * an object from zc_get_network().
		 *
		 * @since 3.9.0
		 *
		 * @param null|false|ZC_Network $network  Network value to return by path. Default null
