...
if ( zc_using_themes() ) {
	 ...
	 *
	 * This action hook executes just before ZelocoreCMS determines which template page to load.
	 ...
	 * without interfering with the ZelocoreCMS loading process.
	 *
	 * @since 1.5.0
	 */
...
if ( is_robots() ) {
	...
	require ABSPATH . 'zc-trackback.php';
	return;
}
...
if ( zc_using_themes() ) {
	...
	if (
		 ...
		 */
		do_action( 'zc_before_include_template', $template );
