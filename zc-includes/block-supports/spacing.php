 ...
 */
function zc_register_spacing_support( $block_type ) {
 ...
 */
function zc_apply_spacing_support( $block_type, $block_attributes ) {
	if ( zc_should_skip_block_supports_serialization( $block_type, 'spacing' ) ) {
		return array();
	}
	...
	$skip_padding         = zc_should_skip_block_supports_serialization( $block_type, 'spacing', 'padding' );
	$skip_margin          = zc_should_skip_block_supports_serialization( $block_type, 'spacing', 'margin' );
	...
	$styles = zc_style_engine_get_styles( array( 'spacing' => $spacing_block_styles ) );
...
ZC_Block_Supports::get_instance()->register(
	'spacing',
	array(
		'register_attribute' => 'zc_register_spacing_support',
		'apply'              => 'zc_apply_spacing_support',
	)
);
