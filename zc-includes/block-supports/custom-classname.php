 ...
 */
function zc_register_custom_classname_support( $block_type ) {
 ...
 */
function zc_apply_custom_classname_support( $block_type, $block_attributes ) {
	$has_custom_classname_support = block_has_support( $block_type, 'customClassName', true );
	$attributes                   = array();
	if ( $has_custom_classname_support ) {
...
ZC_Block_Supports::get_instance()->register(
	'custom-classname',
	array(
		'register_attribute' => 'zc_register_custom_classname_support',
		'apply'              => 'zc_apply_custom_classname_support',
	)
);
