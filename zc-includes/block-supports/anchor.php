 ...
 */
function zc_register_anchor_support( ZC_Block_Type $block_type ) {
 ...
 */
function zc_apply_anchor_support( ZC_Block_Type $block_type, array $block_attributes ): array {
...
ZC_Block_Supports::get_instance()->register(
	'anchor',
	array(
		'register_attribute' => 'zc_register_anchor_support',
		'apply'              => 'zc_apply_anchor_support',
	)
);
