 ...
 *
 * This filter runs during block type registration, before the ZC_Block_Type
 * is instantiated. Block supports add their attributes AFTER the block type
 * is created (via {@see ZC_Block_Supports::register_attributes()}), so any attributes
 ...
 */
function zc_mark_auto_generate_control_attributes( array $args ): array {
...
add_filter( 'register_block_type_args', 'zc_mark_auto_generate_control_attributes', 5 );
