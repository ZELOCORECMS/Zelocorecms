...
final class ZC_Site {
	 ...
	 *
	 * Handling for this does not exist throughout ZelocoreCMS core, but custom
	...
	public static function get_instance( $site_id ) {
		...
		if ( false === $_site ) {
			...
			zc_cache_add( $site_id, $_site, 'sites' );
		}
		...
		return new ZC_Site( $_site );
	}

	/**
	 * Creates a new ZC_Site object.
	 *
	...
	private function get_details() {
		$details = zc_cache_get( $this->blog_id, 'site-details' );
		...
		if ( false === $details ) {
			...
			zc_cache_set( $this->blog_id, $details, 'site-details' );
		}
