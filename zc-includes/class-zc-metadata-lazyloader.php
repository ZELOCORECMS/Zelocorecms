<?php
/**
 * Meta API: ZC_Metadata_Lazyloader class
 *
 * @package ZelocoreCMS
 * @subpackage Meta
 * @since 4.5.0
 ...
 *
 * When loading many objects of a given type, such as posts in a ZC_Query loop, it often makes
...
class ZC_Metadata_Lazyloader {
	 ...
	 * @return void|ZC_Error ZC_Error on failure.
	 */
	public function queue_objects( $object_type, $object_ids ) {
		if ( ! isset( $this->settings[ $object_type ] ) ) {
			return new ZC_Error( 'invalid_object_type', __( 'Invalid object type.' ) );
		}
		 ...
		 * @param ZC_Metadata_Lazyloader $lazyloader  The lazy-loader object.
		 */
	 ...
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use ZC_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
	...
	public function lazyload_term_meta( $check ) {
		_deprecated_function( __METHOD__, '6.3.0', 'ZC_Metadata_Lazyloader::lazyload_meta_callback' );
	 ...
	 * directly, from either inside or outside the `ZC_Query` object.
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use ZC_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
