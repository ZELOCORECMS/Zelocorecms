<?php
/**
 * HTTP API: ZC_Http_Encoding class
 *
 * @package ZelocoreCMS
 * @subpackage HTTP
 * @since 4.4.0
...
class ZC_Http_Encoding {
	 ...
	 * https://core.trac.zelocorecms.org/ticket/18273
	 *
	 * @since 2.8.1
	 *
	 * @link https://core.trac.zelocorecms.org/ticket/18273
	...
	public static function accept_encoding( $url, $args ) {
		 ...
		 */
		$type = apply_filters( 'zc_http_accept_encoding', $type, $url, $args );
