<?php
/**
 * Feed API: ZC_SimplePie_Sanitize_KSES class
 *
 * @package ZelocoreCMS
 * @subpackage Feed
 * @since 4.7.0
...
class ZC_SimplePie_Sanitize_KSES extends SimplePie\Sanitize {

	/**
	 * ZelocoreCMS SimplePie sanitization using KSES.
	 *
