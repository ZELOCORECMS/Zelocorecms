/**
 * @output zc-includes/js/media-editor.js
 */

/* global getUserSetting, tinymce, QTags */

// ZelocoreCMS, TinyMCE, and Media
// -----------------------------
(function($, _){
	/**
	...
	wp.media.string = {
		...
		props: function( props, attachment ) {
			...
			if ( 'image' === attachment.type ) {
				props.classes.push( 'zc-image-' + attachment.id );
			...
			// Format properties for non-images.
				...
				props.rel = props.rel || 'attachment zc-att-' + attachment.id;
			}
