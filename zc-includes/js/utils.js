 ...
 * Cookie functions.
 *
 * @output zc-includes/js/utils.js
 */
...
window.setUserSetting = function( name, value, _del ) {
	...
	var uid = userSettings.uid,
		settings = wpCookies.getHash( 'zc-settings-' + uid ),
	...
	wpCookies.setHash( 'zc-settings-' + uid, settings, 31536000, path, '', secure );
	wpCookies.set( 'zc-settings-time-' + uid, userSettings.time, 31536000, path, '', secure );
...
window.getAllUserSettings = function() {
	...
	return wpCookies.getHash( 'zc-settings-' + userSettings.uid ) || {};
};
