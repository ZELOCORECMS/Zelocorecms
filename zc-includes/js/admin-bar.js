/**
 * @output zc-includes/js/admin-bar.js
 */
/**
...
( function( document, window, navigator ) {
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		adminBarLogout = document.querySelector( '#zc-admin-bar-logout a' );
		adminBarSearchForm = document.getElementById( 'adminbarsearch' );
		shortlink = document.getElementById( 'zc-admin-bar-get-shortlink' );
	...
	function scrollToTop( event ) {
		...
		if (
			...
			event.target.id !== 'zc-admin-bar-top-secondary'
		) {
			return;
		}
