/**
 * @output zc-includes/js/zc-custom-header.js
 */
...
(function( window, settings ) {
			...
			if ( this.supportsVideo() ) {
				for ( var id in this.handlers ) {
					...
					if ( 'test' in handler && handler.test( settings ) ) {
						...
						trigger( document, 'zc-custom-header-video-loaded' );
						break;
					}
				}
			}
	...
	BaseHandler.prototype = {
		...
		initialize: function( settings ) {
			...
			this.container = document.getElementById( 'zc-custom-header' );
			this.button = button;

			button.setAttribute( 'type', 'button' );
			button.setAttribute( 'id', 'zc-custom-header-video-button' );
			button.setAttribute( 'class', 'zc-custom-header-video-button zc-custom-header-video-play' );
	...
	NativeHandler = BaseHandler.extend(/** @lends zc.NativeHandler.prototype */{
		...
		ready: function() {
			...
			video.id = 'zc-custom-header-video';
			video.autoplay = true;
			video.loop = true;
			video.muted = true;
