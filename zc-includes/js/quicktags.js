 ...
 * Quicktags
 *
 * This is the HTML editor in ZelocoreCMS. It can be attached to any textarea and will
 ...
 *
 * @output zc-includes/js/quicktags.js
 */
...
(function(){
	...
	var qt = window.QTags = function(settings) {
		...
		wrap = document.getElementById( 'zc-' + id + '-wrap' );
	 ...
	 * use add_action( 'admin_print_footer_scripts', 'output_my_js', 100 ) or add_action( 'zc_footer', 'output_my_js', 100 )
	 *
