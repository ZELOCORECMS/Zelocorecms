/**
 * zc-emoji.js is used to replace emoji with images in browsers when the browser
 * doesn't support emoji natively.
 *
 * @output zc-includes/js/zc-emoji.js
 */
			...
			params = {
				...
				doNotParse: function( node ) {
					if (
						...
						node.className.indexOf( 'zc-exclude-emoji' ) !== -1
					) {
