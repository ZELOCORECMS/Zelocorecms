...
(wp ||= {}).blocks = (() => {
  ...
  var __EXPERIMENTAL_STYLE_PROPERTY = {
    ...
    "--zc--style--root--padding": {
      value: ["spacing", "padding"],
      support: ["spacing", "padding"],
      properties: {
        "--zc--style--root--padding-top": "top",
        "--zc--style--root--padding-right": "right",
        "--zc--style--root--padding-bottom": "bottom",
        "--zc--style--root--padding-left": "left"
      },
      rootOnly: true
    }
  };
  var __EXPERIMENTAL_ELEMENTS = {
    link: "a:where(:not(.zc-element-button))",
  ...
  var processBlockType = (name, blockSettings) => ({ select: select3 }) => {
    ...
    if (settings.apiVersion <= 2) {
      (0, import_deprecated4.default)("Block with API version 2 or lower", {
        ...
        link: "https://developer.zelocorecms.org/block-editor/reference-guides/block-api/block-api-versions/block-migration-for-iframe-editor-compatibility/"
      });
    }
    ...
    if (!isValidIcon(settings.icon.src)) {
      (0, import_warning2.default)(
        "The icon passed is invalid. The icon should be a string, an element, a function, or an object following the specifications documented in https://developer.zelocorecms.org/block-editor/developers/block-api/block-registration/#icon-optional"
      );
      return;
    }
  ...
  function getBlockDefaultClassName(blockName) {
    const className = "zc-block-" + blockName.replace(/\//, "-").replace(/^core-/, "");
...
<!-- /wp:${blockName} -->`;
  ...
  function convertLegacyBlockNameAndAttributes(name, attributes) {
    ...
    if (name && name.indexOf("core-embed/") === 0) {
      ...
      if (!["amazon-kindle", "zelocorecms"].includes(providerSlug)) {
    ...
    if (name === "core/comments-query-loop") {
      ...
      if (!className.includes("zc-block-comments-query-loop")) {
        newAttributes.className = [
          "zc-block-comments-query-loop",
          className
        ].join(" ");
      }
    }
  ...
  function createMore(customText, noTeaser, doc) {
    const node = doc.createElement("zc-block");
