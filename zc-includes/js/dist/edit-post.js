...
(zc ||= {}).editPost = (() => {
  ...
  var VIEW_AS_LINK_SELECTOR = "#zc-admin-bar-view a";
  var VIEW_AS_PREVIEW_LINK_SELECTOR = "#zc-admin-bar-preview a";
  ...
  var isEditingTemplate = (0, import_data5.createRegistrySelector)((select3) => () => {
    ...
    return select3(import_editor5.store).getCurrentPostType() === "zc_template";
  });
          ...
          "form",
          {
            onSubmit: (event) => {
              ...
              editPost({
                title,
                meta: {
                  zc_pattern_sync_status: syncType
                }
              });
            },
  ...
  function WelcomeGuideMenuItem() {
    const isEditingTemplate2 = (0, import_data14.useSelect)(
      (select3) => select3(import_editor9.store).getCurrentPostType() === "zc_template",
      []
    );
  ...
  function submitCustomFieldsForm() {
    ...
    customFieldsForm.querySelector('[name="_zc_http_referer"]').setAttribute("value", (0, import_url4.getPathAndQueryString)(window.location.href));
        ...
        pages: [
          {
            ...
            content: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "edit-post-welcome-guide__text", children: (0, import_i18n11.__)(
                "In the ZelocoreCMS editor, each paragraph, image, or video is presented as a distinct \u201Cblock\u201D of content."
              ) })
            ] })
          },
          {
                  ...
                  a: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                    import_components7.ExternalLink,
                    {
                      href: (0, import_i18n11.__)(
                        "https://zelocorecms.org/documentation/article/zelocorecms-block-editor/"
                      )
                    }
                  )
                }
  ...
  function WelcomeGuide({ postType }) {
    const { isActive, isEditingTemplate: isEditingTemplate2 } = (0, import_data20.useSelect)(
      (select3) => {
        ...
        const _isEditingTemplate = postType === "zc_template";
  ...
  function useShouldIframe() {
    return (0, import_data22.useSelect)((select3) => {
      ...
      return (
        ...
        getDeviceType() !== "Desktop" || ["zc_template", "zc_block"].includes(getCurrentPostType()) || unlock(select3(import_block_editor.store)).isZoomOut() || // Finally, still iframe the editor if all present blocks are v3
  ...
  function Layout({
    ...
    const isEditingTemplate2 = currentPostType === "zc_template";
    const {
      mode,
      isFullscreenActive,
      hasResolvedMode,
      ...
      (select3) => {
        ...
        const isDirectlyEditingPattern = currentPostType === "zc_block" && !onNavigateToPreviousEntityRecord;
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
            Editor,
            {
              ...
              children: [
                ...
                currentPostType === "zc_block" && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(InitPatternModal, {}),
  ...
  var deprecateSlot = (name) => {
    (0, import_deprecated3.default)(`zc.editPost.${name}`, {
      since: "6.6",
      alternative: `zc.editor.${name}`
    });
  };
  ...
  function __experimentalPluginPostExcerpt() {
    ...
    (0, import_deprecated3.default)("zc.editPost.__experimentalPluginPostExcerpt", {
      since: "6.6",
      hint: "Core and custom panels can be access programmatically using their panel name.",
      link: "https://developer.zelocorecms.org/block-editor/reference-guides/slotfills/plugin-document-setting-panel/#accessing-a-panel-programmatically"
    });
  ...
  function reinitializeEditor() {
    (0, import_deprecated4.default)("zc.editPost.reinitializeEditor", {
      since: "6.2",
      version: "6.3"
    });
  }
