...
import {
  ...
  withSyncEvent,
  withScope
} from "@zelocorecms/interactivity";
...
var focusableSelectors = [
  ".zc-lightbox-close-button",
  ".zc-lightbox-navigation-button"
];
  ...
  "core/image",
  {
    ...
    callbacks: {
      setOverlayStyles() {
        ...
        state.overlayStyles = `
					--zc--lightbox-initial-top-position: ${screenPosY}px;
					--zc--lightbox-initial-left-position: ${screenPosX}px;
					--zc--lightbox-container-width: ${containerWidth + 1}px;
					--zc--lightbox-container-height: ${containerHeight + 1}px;
					--zc--lightbox-image-width: ${lightboxImgWidth}px;
					--zc--lightbox-image-height: ${lightboxImgHeight}px;
					--zc--lightbox-scale: ${containerScale};
					--zc--lightbox-scrollbar-width: ${window.innerWidth - document.documentElement.clientWidth}px;
				`;
      },
      setButtonStyles() {
      ...
      setInertElements() {
        document.querySelectorAll("body > :not(.zc-lightbox-overlay)").forEach((el) => {
          if (state.overlayEnabled) {
