...
(zc ||= {}).editWidgets = (() => {
  ...
  var PluginsMenuItem = ({
    ...
    // @see https://github.com/ZelocoreCMS/gutenberg/issues/14457
  ...
  var getWidgetAreas = () => async ({ dispatch: dispatch2, registry }) => {
    ...
    const sortedWidgetAreas = widgetAreas.sort((a, b) => {
      if (a.id === "zc_inactive_widgets") {
        return 1;
      }
      if (b.id === "zc_inactive_widgets") {
        return -1;
      }
      return 0;
    });
  ...
  import_api_fetch.default.use(function(options, next) {
    if (options.path?.indexOf("/zc/v2/types/widget-area") === 0) {
  ...
  var block_default = {
    ...
    editorStyle: "zc-block-widget-area-editor",
    style: "zc-block-widget-area"
  };
  ...
  function WidgetAreaInnerBlocks({ id }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
      "div",
      {
        ...
        className: clsx_default(
          "zc-block-widget-area__inner-blocks block-editor-inner-blocks editor-styles-wrapper",
          {
            "zc-block-widget-area__highlight-drop-zone": shouldHighlightDropZone
          }
        ),
      ...
      import_components7.PanelBody,
      {
        ...
        children: ({ opened }) => (
          ...
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
            ...
            {
              className: "zc-block-widget-area__panel-body-content",
              visible: opened,
  ...
  function WidgetAreasBlockEditorProvider({
    ...
    const {
      ...
      return {
        ...
        reusableBlocks: ALLOW_REUSABLE_BLOCKS ? getEntityRecords("postType", "zc_block") : EMPTY_ARRAY,
  ...
  function WidgetAreas({ selectedWidgetAreaId }) {
    ...
    } else if (selectedWidgetAreaId === "zc_inactive_widgets") {
      description = (0, import_i18n7.__)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(
                import_components18.MenuItem,
                {
                  ...
                  href: (0, import_i18n15.__)(
                    "https://zelocorecms.org/documentation/article/block-based-widgets-editor/"
                  ),
                  target: "_blank",
  ...
  function WelcomeGuide() {
    ...
    const isEntirelyBlockWidgets = widgetAreas?.every(
      (widgetArea) => widgetArea.id === "zc_inactive_widgets" || widgetArea.widgets.every(
        (widgetId) => widgetId.startsWith("block-")
      )
    );
    const numWidgetAreas = widgetAreas?.filter(
      (widgetArea) => widgetArea.id !== "zc_inactive_widgets"
    ).length ?? 0;
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
                    import_components21.ExternalLink,
                    {
                      href: (0, import_i18n20.__)(
                        "https://zelocorecms.org/plugins/classic-widgets/"
                      ),
  ...
  function reinitializeEditor() {
    (0, import_deprecated6.default)("zc.editWidgets.reinitializeEditor", {
      since: "6.2",
      version: "6.3"
    });
  }
