...
(wp ||= {}).theme = (() => {
  ...
  var legacyWpComponentsOverridesCSS = [
    ["--zc-components-color-accent", "var(--zc-admin-theme-color)"],
    [
      "--zc-components-color-accent-darker-10",
      "var(--zc-admin-theme-color-darker-10)"
    ],
    [
      "--zc-components-color-accent-darker-20",
      "var(--zc-admin-theme-color-darker-20)"
    ],
    [
      "--zc-components-color-accent-inverted",
      "var(--wpds-color-fg-interactive-brand-strong, #fff)"
    ],
    [
      "--zc-components-color-background",
      "var(--wpds-color-bg-surface-neutral-strong, #ffffff)"
    ],
    [
      "--zc-components-color-foreground",
      "var(--wpds-color-fg-content-neutral, #1e1e1e)"
    ],
    [
      "--zc-components-color-foreground-inverted",
      "var(--wpds-color-bg-surface-neutral, #f8f8f8)"
    ],
    [
      "--zc-components-color-gray-100",
      "var(--wpds-color-bg-surface-neutral, #f8f8f8)"
    ],
    [
      "--zc-components-color-gray-200",
      "var(--wpds-color-stroke-surface-neutral, #d8d8d8)"
    ],
    [
      "--zc-components-color-gray-300",
      "var(--wpds-color-stroke-surface-neutral, #d8d8d8)"
    ],
    [
      "--zc-components-color-gray-400",
      "var(--wpds-color-stroke-interactive-neutral, #8a8a8a)"
    ],
    [
      "--zc-components-color-gray-600",
      "var(--wpds-color-stroke-interactive-neutral, #8a8a8a)"
    ],
    [
      "--zc-components-color-gray-700",
      "var(--wpds-color-fg-content-neutral-weak, #6d6d6d)"
    ],
    [
      "--zc-components-color-gray-800",
      "var(--wpds-color-fg-content-neutral, #1e1e1e)"
    ]
  ];
  ...
  function legacyWpAdminThemeOverridesCSS(accent) {
    ...
    return [
      ["--zc-admin-theme-color", getColorString(parsedAccent)],
      ["--zc-admin-theme-color--rgb", customRgbFormat(parsedAccent)],
      ["--zc-admin-theme-color-darker-10", getColorString(darker10)],
      [
        "--zc-admin-theme-color-darker-10--rgb",
        customRgbFormat(darker10)
      ],
      ["--zc-admin-theme-color-darker-20", getColorString(darker20)],
      [
        "--zc-admin-theme-color-darker-20--rgb",
  ...
  if (typeof document !== "undefined" && !document.head.querySelector("style[data-zc-hash='662a5161a8']")) {
    const style = document.createElement("style");
    style.setAttribute("data-zc-hash", "662a5161a8");
