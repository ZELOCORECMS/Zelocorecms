/**
 * @output zc-includes/js/mce-view.js
 */
...
( function( window, zc, shortcode, $ ) {
	...
	_.extend( zc.mce.View.prototype, /** @lends zc.mce.View.prototype */{
			...
			this.getNodes( function( editor, node ) {
				...
				tinymce.each( dom.$( 'link[rel="stylesheet"]', editorHead ), function( link ) {
					if ( link.href && link.href.indexOf( 'skins/lightgray/content.min.css' ) === -1 &&
						link.href.indexOf( 'skins/zelocorecms/zc-content.css' ) === -1 ) {
		 ...
		 * @param {string} dashicon A dashicon ID. Optional. {@link https://developer.zelocorecms.org/resource/dashicons/}
		 */
