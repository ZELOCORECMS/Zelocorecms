...
( function() {
	...
	tinyMCE.addI18n( lang + ".zelocorecms", {
		zc_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		zc_more_desc: "Insert More Tag (Alt + Shift + T)",
		zc_page_desc: "Insert Page break (Alt + Shift + P)",
		zc_help_desc: "Help (Alt + Shift + H)",
		zc_more_alt: "More...",
		zc_page_alt: "Next page...",
		add_media: "Add Media",
