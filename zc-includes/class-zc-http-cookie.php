 ...
 * already a ZC_Http_Cookie() object, then they are turned into one.
 *
 * @todo The ZelocoreCMS convention is to use underscores instead of camelCase for function and method
 * names. Need to switch to use underscores instead for the methods.
 *
 * @since 2.8.0
 */
#[AllowDynamicProperties]
class ZC_Http_Cookie {
	 ...
	 */
	public function getHeaderValue() { // phpcs:ignore ZelocoreCMS.NamingConventions.ValidFunctionName.MethodNameInvalid
		 ...
		 */
		return $this->name . '=' . apply_filters( 'zc_http_cookie_value', $this->value, $this->name );
	}

	/**
	 * Retrieve cookie header for usage in the rest of the ZelocoreCMS HTTP API.
	 *
	 * @since 2.8.0
	 *
	 * @return string
	 */
	public function getFullHeader() { // phpcs:ignore ZelocoreCMS.NamingConventions.ValidFunctionName.MethodNameInvalid
